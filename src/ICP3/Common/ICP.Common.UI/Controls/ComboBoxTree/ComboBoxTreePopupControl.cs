...
namespace ICP.Common.UI.Controls
{
    ...
    public partial class ComboBoxTreePopupControl : UserControl
    {
        ...
        public ComboBoxTreePopupControl()
        {
            ...
            {
                this._ownerEditControl.QueryResultValue -= _ownerEditControl_QueryResultValue;
                this._ownerEditControl.TextChanged -= _ownerEditControl_TextChanged;
                this.treeList1.MouseDoubleClick -= treeList1_MouseDoubleClick;
                this.treeList1.BeforeCheckNode -= treeList1_BeforeCheckNode;
                this.treeList1.AfterCheckNode -= treeList1_AfterCheckNode;
                this._ownerEditControl = null;
