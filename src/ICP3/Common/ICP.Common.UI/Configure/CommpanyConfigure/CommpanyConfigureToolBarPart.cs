//-----------------------------------------------------------------------
// <copyright file="CommpanyConfigureToolBarPart.cs" company="LongWin">
...
namespace ICP.Common.UI.Configure.CommpanyConfigure
{
    ...
    [SmartPart]
    internal class CommpanyConfigureToolBarPart : BaseToolBar
    {
        #region 服务
        ...
        public CommpanyConfigureToolBarPart()
        {
        ...
        {
            this.WorkItem.Commands[CommpanyConfigureConstants.CMD_AddCommpany].AddInvoker(barAdd, "ItemClick");
            this.WorkItem.Commands[CommpanyConfigureConstants.CMD_Disable].AddInvoker(barDisuse, "ItemClick");
            this.WorkItem.Commands[CommpanyConfigureConstants.CMD_Refresh].AddInvoker(barRefresh, "ItemClick");
            //this.WorkItem.Commands[CommpanyConfigureConstants.CMD_Close].AddInvoker(barClose, "ItemClick");
        ...
        /// <param name="s"></param>
        /// <param name="e"></param>
        [CommandHandler(CommpanyConfigureConstants.CMD_Close)]
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "CommpanyConfigureToolBarPart";
