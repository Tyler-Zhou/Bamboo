...
{
    public class ChargingCodeFinder : IDataFinder,IDisposable
    {
        /// <summary>
        /// IDataFinder 成员
        /// </summary>
        ...
        ChargingCodeSingleFinderWorkitem singleFinderWorkitem = null;
            ...
            , FinderTriggerType triggerType, string workspaceName)
        {
            ...
            {
                if (DataChoosed != null)
                    DataChoosed(this, new DataFindEventArgs(CommonUtility.GetSingleSearchResult<SolutionChargingCodeList>(list[0], returnFields)));
            ...
            singleFinderWorkitem = Workitem.WorkItems.Get<ChargingCodeSingleFinderWorkitem>(this.GetHashCode().ToString() + "ChargingCodeSingleFinderWorkitem");
            if (singleFinderWorkitem == null)
            {
                singleFinderWorkitem = Workitem.WorkItems.AddNew<ChargingCodeSingleFinderWorkitem>(this.GetHashCode().ToString() + "ChargingCodeSingleFinderWorkitem");
    ...
    public class ChargingCodeWorkSpaceConstants
    {
    ...
    public class ChargingCodeCommonConstants
    {
