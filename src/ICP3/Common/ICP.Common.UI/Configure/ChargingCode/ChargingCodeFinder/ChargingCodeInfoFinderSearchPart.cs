...
{
    [ToolboxItem(false)]
    public partial class ChargingCodeInfoFinderSearchPart : ICP.Framework.ClientComponents.UIFramework.BaseSearchPart
    {
        #region serivce
        [ServiceDependency]
        ...
        public ChargingCodeInfoFinderSearchPart()
        {
            InitializeComponent();
        ...
        public override object GetData()
        {
            List<ChargingCodeList> list = ConfigureService.GetChargingCodeListBySearch(
                this.txtCode.Text.Trim(), txtName.Text.Trim(), null, this.chkIsConnission.Checked, this.chkValid.Checked, 100);
            return list;
        }
