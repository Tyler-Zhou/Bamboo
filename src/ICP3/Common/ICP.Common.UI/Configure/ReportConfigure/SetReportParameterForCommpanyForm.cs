...
using Microsoft.Practices.CompositeUI;
    ...
    public partial class SetReportParameterForCommpanyForm : DevExpress.XtraEditors.XtraForm
    {
        private ConfigureListForReport _currentReportConfigure;
        ...
        public SetReportParameterForCommpanyForm()
        {
            InitializeComponent();
            this.Disposed += delegate {
               
                this._currentReportConfigure = null;
                this._reportValueTemp = null;
        ...
        private void InitControls()
        {
            ...
            foreach (var item in parameters)
            {
                if (item.ParameterType == ReportParameterType.Bool)
                {
                    if (!string.IsNullOrEmpty(item.ParameterValue) && item.ParameterValue.ToUpper() == "TRUE")
                    {
        ...
        /// 当前报表配置
        /// </summary>
        public ConfigureListForReport CurrentCompanyConfigure
        {
            get
            {
