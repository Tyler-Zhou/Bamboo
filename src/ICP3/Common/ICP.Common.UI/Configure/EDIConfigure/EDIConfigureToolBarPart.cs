...
namespace ICP.Common.UI.Configure.EDIConfigure
{
    ...
    [SmartPart]
    internal class EDIConfigureToolBarPart : BaseToolBar
    {
        #region 服务
        ...
        public EDIConfigureToolBarPart()
        {
        ...
        {
            this.WorkItem.Commands[EDIConfigureConstants.CMD_AddEDI].AddInvoker(barAdd, "ItemClick");
            this.WorkItem.Commands[EDIConfigureConstants.CMD_Disable].AddInvoker(barDisuse, "ItemClick");
            this.WorkItem.Commands[EDIConfigureConstants.CMD_Refresh].AddInvoker(barRefresh, "ItemClick");
            //this.WorkItem.Commands[EDIConfigureConstants.CMD_Close].AddInvoker(barClose, "ItemClick");
        ...
        /// <param name="s"></param>
        /// <param name="e"></param>
        [CommandHandler(EDIConfigureConstants.CMD_Close)]
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "EDIConfigureToolBarPart";
