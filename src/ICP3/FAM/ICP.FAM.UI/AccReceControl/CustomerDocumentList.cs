...
namespace ICP.FAM.UI.AccReceControl
{
    public class CustomerDocumentList : BaseDocumentList
    {
        ...
        protected override void InitUploadSubItems()
        {
            ...
            btnItem.Tag = EnumHelper.GetDescription<DocumentType>(DocumentType.AC, LocalData.IsEnglish);
            btnItem.Caption = EnumHelper.GetDescription<DocumentType>(DocumentType.AC,LocalData.IsEnglish);
