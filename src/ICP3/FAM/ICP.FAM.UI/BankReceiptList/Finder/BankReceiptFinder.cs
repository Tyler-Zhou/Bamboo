...
{
    public class BankReceiptFinder : IDataFinder, IDisposable
    {
        /// <summary>
        /// IDataFinder 成员
        /// </summary>
        ...
        private const string CustomerFinderWorkspace = "BankReceiptFinderWorkspace";
