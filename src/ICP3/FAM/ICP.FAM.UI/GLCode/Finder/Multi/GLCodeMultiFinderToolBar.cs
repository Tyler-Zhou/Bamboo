...
{
    [ToolboxItem(false)]
    public partial class GLCodeMultiFinderToolBar : BaseToolBar
    {
        #region Service
        ...
        public GLCodeMultiFinderToolBar()
        {
            InitializeComponent();
            Disposed += delegate {
                _barItemDic.Clear();
        ...
        {
            Workitem.Commands[GLCodeCommandConstants.Command_FinderSelect].Execute();
        }

        private void barAdd_ItemClick(object sender, ItemClickEventArgs e)
        {
            Workitem.Commands[GLCodeCommandConstants.Command_GLCodeAdd].Execute();
        }

        private void barSearch_ItemClick(object sender, ItemClickEventArgs e)
        {
            Workitem.Commands[GLCodeCommandConstants.Command_GLCodeShowSearch].Execute();
        }
