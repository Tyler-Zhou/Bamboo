...
namespace ICP.FAM.UI.BankTransaction.Finder
{
    ...
    public partial class SingleFinderToolBar : BaseEditPart
    {
        ...
        {
            Workitem.Commands[BankTransactionFinderConstants.COMMANDSINGLEFINDERCONFIRM].Execute();
            var findForm = FindForm();
            if (findForm != null) findForm.Close();
        }
        ...
        {
            Workitem.Commands[BankTransactionFinderConstants.COMMANDSINGLEFINDERSHOWSEARCH].Execute();
        }
        ...
        public override object DataSource
        {
            ...
            set
            {
                BankTransactionInfo data = value as BankTransactionInfo;
