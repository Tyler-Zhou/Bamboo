...
{
    [ToolboxItem(false)]
    public partial class ReleaseBLEditPart : BaseEditPart
    {
        #region 服务注入
        [ServiceDependency]
        ...
        private void InitState()
        {
            if (_CurrentData.State == ReleaseBLState.Released || _CurrentData.State == ReleaseBLState.Received)
            {
                if (_CurrentData.ReleaseType == ReleaseType.Original)
                {
                    ...
                    _CurrentData.HasSentOriginal = true;
                }
                else
                {
                    chkNoticedTelex.Checked = true;
                    _CurrentData.HasNoticedTelex = true;
                }
            ...
            chkNoticedTelex.CheckedChanged += delegate
            {
                if (chkNoticedTelex.Checked)
                {
                    ...
                    if (_CurrentData.TelexNo.IsNullOrEmpty() && _CurrentData.ReleaseType == ReleaseType.Telex)
                    {
                        ...
                        _CurrentData.TelexNo = _CurrentData.BlNo + DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Year.ToString()
                            + (DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Month >= 10 ? DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Month.ToString() : "0" + DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Month.ToString())
                            + (DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Day >= 10 ? DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Day.ToString() : "0" + DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Day.ToString())
                            + (DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Minute >= 10 ? DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Minute.ToString() : "0" + DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Minute.ToString())
                            + (DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Second >= 10 ? DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Second.ToString() : "0" + DateTime.SpecifyKind(DateTime.Now,DateTimeKind.Unspecified).Second.ToString());
                    }
                }
                else
                {
        ...
        private bool Save(ReleaseBLList currentData)
        {
        ...
        void BindingData(object data)
        {
            ...
            if (_CurrentData.ReleaseType == ReleaseType.Original)
                rdoReleaseType.EditValue = 0;
            else
                rdoReleaseType.EditValue = 1;
        ...
        private void chkNoticedTelex_CheckedChanged(object sender, EventArgs e)
        {
