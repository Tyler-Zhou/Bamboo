...
namespace LongWin.DataWarehouseReport.WinUI
{
    ...
    /// 应付帐款表
    /// </summary>
    public class DcNoteForCRWorkItem:WorkItem
    {
        ...
        internal void Show(IWorkspace workspace)
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                info.Title = Utility.GetValueString("应付帐款表", "应付帐款表"); 
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            {
                this._ListPart.ReportName = "RPT_DebitnoteForCR_Total";
            ...
            {
                this._ListPart.ReportName = "RPT_Debitnote_DetailCR";
                ...
                this._paramList.Add(new ReportParameter("Type", "1"));
