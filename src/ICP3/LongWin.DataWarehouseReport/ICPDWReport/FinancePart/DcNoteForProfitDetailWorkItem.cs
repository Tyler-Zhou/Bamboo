...
namespace LongWin.DataWarehouseReport.WinUI
{
    ...
    /// 盈余表
    /// </summary>
    public class DcNoteForProfitDetailWorkItem:WorkItem
    {
        ReportMainSpace reportMainWorkSpace;
        DcNoteForProfitDetailSearchPart _SearchPart;
        ...
        internal void Show(IWorkspace workspace)
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                info.Title = Utility.GetValueString("应收应付盈余表", "应收应付盈余表"); 
                ...
                {
                    this._SearchPart = this.Items.AddNew<DcNoteForProfitDetailSearchPart>();
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            this._paramList.Add(new ReportParameter("FeecodeSet", this._SearchPart.BillingCodes));
            this._paramList.Add(new ReportParameter("JobType", this._SearchPart.BusinessTypes));
            this._paramList.Add(new ReportParameter("GroupCount","2"));
            ...
            this._paramList.Add(new ReportParameter("GroupFields",""));
            ...
            //显示报表的用法
            this._ListPart.ReportName = "RPT_DebitnoteForProfit_Detail";
