...
{
    public class ProfitForComposeWorkItem:WorkItem
    {
        ReportMainSpace reportMainWorkSpace;
        ProfitForJobType_Search _SearchPart;
        ...
        internal void Show(IWorkspace workspace)
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                info.Title = Utility.GetValueString("利润组成分析表","利润组成分析表");
                ...
                {
                    this._SearchPart = this.Items.AddNew<ProfitForJobType_Search>();
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            //如果是统计表
            this._ListPart.ReportName = "RPT_ALLProfitForCompose";
            ...
            //this._paramList.Add(new ReportParameter("ViewMode", this._SearchPart.ViewMode));    
