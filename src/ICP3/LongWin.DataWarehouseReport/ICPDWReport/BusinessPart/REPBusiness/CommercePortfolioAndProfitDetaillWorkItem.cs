...
{
    public class CommercePortfolioAndProfitDetaillWorkItem:WorkItem
    {
        ...
        internal void GetService()
        {
            ...
            {
                this._SearchPart = this.Items.AddNew<CommerceDetailForBox_Search>();
        ...
        CommerceDetailForBox_Search _SearchPart;
        ...
        internal void Show(IWorkspace workspace)
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                info.Title = Utility.GetValueString("商务箱量利润详细表", "商务箱量利润详细表");
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            this._ListPart.ReportName = "RPT_CommercePortfolioAndProfitForGeneral_Detail";
