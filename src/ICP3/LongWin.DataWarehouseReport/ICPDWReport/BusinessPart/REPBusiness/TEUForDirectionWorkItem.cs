...
{
    public class TEUForDirectionWorkItem : WorkItem
    {
        ReportMainSpace reportMainWorkSpace;
        DirectionForT_Search _SearchPart;
        ...
        internal void Show(IWorkspace workspace,string Title)
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                {
                    this._SearchPart = this.Items.AddNew<DirectionForT_Search>();
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            //如果是统计表
            this._ListPart.ReportName = "RPT_ALLGetDirectionForTEU";
