...
namespace LongWin.DataWarehouseReport.WinUI
{
    ...
    /// 利润趋势图
    /// </summary>
    public class ProfitForDirectionWorkItem : WorkItem
    {
        ReportMainSpace reportMainWorkSpace;
        DirectionForProFitTotal_Search _SearchPart;
        ...
        internal void Show(IWorkspace workspace,string Title) 
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                {
                    this._SearchPart = this.Items.AddNew<DirectionForProFitTotal_Search>();
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            //如果是统计表
            this._ListPart.ReportName = "RPT_ALLGetDirectionForProfit";
            ...
            this._paramList.Add(new ReportParameter("IsDayOrMonth", this._SearchPart.ViewMode));
