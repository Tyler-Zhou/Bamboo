...
namespace LongWin.DataWarehouseReport.WinUI
{
    ...
    ///  箱量利润详细表(detail) 
    /// </summary>
    public partial class DetailForBox_Search : UserControl
    {
        #region 服务注入
        ...
        public DetailForBox_Search()
        {
            InitializeComponent();
            this.cmbGroupBy.Items = null;
            if (!this.DesignMode)
            {
                this.Disposed += new EventHandler(DetailForBox_Search_Disposed);
            }
        }
        ...
        private void InitData()
        {
            ...
            DataSet ds = this._repBaseDataService.GetStructureNodesByCurrentUser();
        ...
        void DetailForBox_Search_Disposed(object sender, EventArgs e)
        {
