...
namespace LongWin.DataWarehouseReport.WinUI
{
    ...
    ///  利润趋势 
    /// </summary>
    public partial class DirectionForProFitTotal_Search : UserControl
    {
        #region 服务注入
        ...
        public DirectionForProFitTotal_Search()
        {
            InitializeComponent();
            this.Disposed += new EventHandler(DirectionForProFitTotal_Search_Disposed);
        }

        void DirectionForProFitTotal_Search_Disposed(object sender, EventArgs e)
        {
