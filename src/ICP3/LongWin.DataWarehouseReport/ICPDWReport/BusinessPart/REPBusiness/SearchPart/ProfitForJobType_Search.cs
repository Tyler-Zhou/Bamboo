...
namespace LongWin.DataWarehouseReport.WinUI
{
    ...
    /// 利润组成分析的查询面板
    /// </summary>
    public partial class ProfitForJobType_Search : UserControl
    {
        #region 服务注入
        ...
        public ProfitForJobType_Search()
        {
            InitializeComponent();
            this.Disposed += new EventHandler(ProfitForJobType_Search_Disposed);
        }

        void ProfitForJobType_Search_Disposed(object sender, EventArgs e)
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!this.DesignMode)
            {
                ...
                this.ccmbJobType.Items = new string[] {
                                                        ...
                                                        Utility.GetValueString("其它业务", "其它业务") ,
                ...
                this.cmbViewMode.Items.AddRange(new string[] {
        ...
        public string JobType
        {
            get
            {
                //if (this.cmbViewMode.SelectedIndex == 1)
                //{
                    ...
                    if (jobType.Contains(Utility.GetValueString("其他业务", "其他业务") )
                        || jobType.Contains(Utility.GetValueString("其它业务", "其它业务")))
                    {
        ...
        public string XMLCondition
        {
            get
            {
                ...
                writer.WriteValue(this.ViewMode);
                writer.WriteEndElement();
