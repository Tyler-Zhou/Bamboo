...
namespace LongWin.DataWarehouseReport.WinUI
{
    ...
    ///  箱量同期比较 
    /// </summary>
    public partial class SameTermCompareForT_Search : UserControl
    {
        #region 服务注入
        ...
        public SameTermCompareForT_Search()
        {
            InitializeComponent();
            this.Disposed += new EventHandler(SameTermCompareForT_Search_Disposed);
        }

        void SameTermCompareForT_Search_Disposed(object sender, EventArgs e)
        {
        ...
        void ResetControl()
        {
            ...
            if (this.chbCTM.Checked)
            {
                ...
                else if (JobTypeBit.Substring(5, 1) == "1")
                {
