...
namespace LongWin.DataWarehouseReport.WinUI
{
    ...
    ///  利润趋势 
    /// </summary>
    public partial class SameTermCompareForPorfit_Search : UserControl
    {
        #region 服务注入
        ...
        public SameTermCompareForPorfit_Search()
        {
            InitializeComponent();
            this.Disposed += new EventHandler(SameTermCompareForPorfit_Search_Disposed);
        }

        void SameTermCompareForPorfit_Search_Disposed(object sender, EventArgs e)
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!this.DesignMode)
            {
                ...
                this.cmbGroupByField.SelectedIndex = 0;
                //this.cmbSalesType.SelectedIndex = 4;
            }
        }
        ...
        public string XMLCondition
        {
            get
            {
                ...
                writer.WriteValue(this.ucDateTime.MonthSelectedStr);
                writer.WriteEndElement();
        ...
        public string Moths
        {
            get
            {
                return this.ucDateTime.MonthSelectedStr;
            }
        }
        ...
        private void txtAgent_Load(object sender, EventArgs e)
        {
        ...
        private void ucSelectCompany_Load(object sender, EventArgs e)
        {
