...
{
    public class SameTermCompareForTWorkItem : WorkItem
    {
        ReportMainSpace reportMainWorkSpace;
        SameTermCompareForT_Search _SearchPart;
        ...
        internal void Show(IWorkspace workspace,string Title)
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                {
                    this._SearchPart = this.Items.AddNew<SameTermCompareForT_Search>();
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            //如果是统计表
            this._ListPart.ReportName = "RPT_ALLGetSameTermCompareForT";
