...
{
    public class GetJobInfoForCargoTracking_SearchWorkItem:WorkItem
    {
        ReportMainSpace reportMainWorkSpace;
        GetJobInfoForCargoTracking_Search _SearchPart;
        ...
        internal void Show(IWorkspace workspace)
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                info.Title = Utility.GetValueString("业务数据核对表", "业务数据核对表");
                ...
                {
                    this._SearchPart = this.Items.AddNew<GetJobInfoForCargoTracking_Search>();
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            this._ListPart.ReportName = "RPT_GetJobInfoForCargoTracking";
