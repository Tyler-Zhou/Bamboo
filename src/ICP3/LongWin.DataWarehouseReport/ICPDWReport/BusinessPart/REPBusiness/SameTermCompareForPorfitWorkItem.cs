...
{
    public class SameTermCompareForPorfitWorkItem : WorkItem
    {
        ReportMainSpace reportMainWorkSpace;
        SameTermCompareForPorfit_Search _SearchPart;
        ...
        internal void Show(IWorkspace workspace,string Title)
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                {
                    this._SearchPart = this.Items.AddNew<SameTermCompareForPorfit_Search>();
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            //如果是统计表
            this._ListPart.ReportName = "RPT_ALLGetSameTermCompareForProfit";
            ...
            //this._paramList.Add(new ReportParameter("TotalClass", "0"));
            this._paramList.Add(new ReportParameter("Months", this._SearchPart.Moths));
