...
{
    public partial class TotalCostSameTermCompare_SearchPart : UserControl
    {
        #region 服务注入
        ...
        public TotalCostSameTermCompare_SearchPart()
        {
            InitializeComponent();
        ...
        void Cost_Detail_SearchPart_Load(object sender, System.EventArgs e)
        {
            if (!this.DesignMode)
            {
                ...
                //{
                //this.ultraExplorerBarContainerControl1.Size = new Size(171, 135);
                //}
                //else
                //{
                //    this.ultraExplorerBarContainerControl1.Size = new Size(225, 138);
                //}
        ...
        {
            get { return this.dtDateTime.DateTimeFrom; }
        }
        /// <summary>
        /// 结束时间
        /// </summary>
        ...
        {
            get { return this.dtDateTime.DateTimeTo; }
        }
        #endregion
        ...
        {
            get { return this.dtDateTime.DateTimeFrom.ToShortDateString() + " - " + this.dtDateTime.DateTimeTo.ToShortDateString(); }
        }
        /// <summary>
        /// 附加信息
        /// </summary>
        ...
        public string XMLCondition
        {
            get
            {
                ...
                writer.WriteValue(this.dtDateTime.MonthSelectedStr);
                writer.WriteEndElement();
