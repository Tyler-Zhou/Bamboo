...
{
    public partial class TotalCostDirection_SearchPart : UserControl
    {
        #region 服务注入
        ...
        public TotalCostDirection_SearchPart()
        {
            InitializeComponent();
        ...
        void Cost_Detail_SearchPart_Load(object sender, System.EventArgs e)
        {
            if (!this.DesignMode)
            {
                ...
                this.cmbTotalType.Items.Clear();
                this.cmbTotalType.Items.AddRange(new string[]{
                ...
                this.cmbTotalType.SelectedIndex = 0;
            }
        }
        ...
        public string TotalType
        {
            get
            {
                return this.cmbTotalType.SelectedIndex.ToString();
            }
        }
        ...
        public int IsYear
        {
            get
            {
                if (this.cmbTotalType.SelectedIndex == 1)
                    return 0;
                else
                    return 1;
            }
        ...
        public string XMLCondition
        {
            get
            {
                ...
                writer.WriteValue(this.TotalType);
                writer.WriteEndElement();
