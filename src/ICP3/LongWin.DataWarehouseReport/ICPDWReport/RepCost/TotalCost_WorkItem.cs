...
{
    public class TotalCost_WorkItem:WorkItem
    {
        ReportMainSpace reportMainWorkSpace;
        TotalCostl_SearchPart _SearchPart;
        ...
        internal void Show(IWorkspace workspace)
        {
            if (this.reportMainWorkSpace == null)
            {
                ...
                info.Title = Utility.GetValueString("成本分析图", "成本分析图"); 
                ...
                {
                    this._SearchPart = this.Items.AddNew<TotalCostl_SearchPart>();
        ...
        void _SearchPart_SearchResult(object sender, EventArgs e)
        {
            ...
            this._ListPart.ReportName = "RPT_ALLCostFor_Total";
