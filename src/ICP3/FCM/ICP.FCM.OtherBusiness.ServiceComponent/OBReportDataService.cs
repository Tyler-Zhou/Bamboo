...
namespace ICP.FCM.OtherBusiness.ServiceComponent
{
    ...
    partial class OBReportDataService : IOBReportDataService
    {
        ...
        public OBReportDataService(IFrameworkInitializeService frameworkInitializeService)
        {
        ...
        /// <returns></returns>
        public OBOrderReportData GetOBOrderReportData(Guid orderID, Guid companyID)
        {
            try
            {
        ...
        /// 
        /// </summary>
        /// <param name="mblReleaseType"></param>
        /// <param name="hblReleaseType"></param>
        /// <returns></returns>
