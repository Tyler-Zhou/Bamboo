namespace ICP.FCM.OtherBusiness.ServiceInterface.DataObjects
{
    ...
    /// </summary>
    [Serializable]
    public partial class TruckInfo : BaseDataObject
    {
        /// <summary>
        /// IsNew
        /// </summary>
        ...
        Guid _obshippingorderid;
        /// <summary>
        /// 装货单ID
        /// </summary>
        public Guid OBBookingID
        {
            get
            {
                return _obshippingorderid;
            }
            set
            {
                if (_obshippingorderid != value)
                {
                    _obshippingorderid = value;
                    base.OnPropertyChanged("OBBookingID", value);
                }
            }
        }
        ...
        List<AirTruckContainerInfo> _containers;
        /// <summary>
        /// 箱列表
        /// </summary>
        public List<AirTruckContainerInfo> Containers
        {
            get
            {
                return _containers;
    ...
    /// </summary>
    [Serializable]
    public partial class AirTruckContainerInfo : OBContainerList
    {
