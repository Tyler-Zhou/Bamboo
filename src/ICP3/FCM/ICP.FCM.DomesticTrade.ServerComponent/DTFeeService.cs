...
namespace ICP.FCM.DomesticTrade.ServiceComponent
{
    partial class DomesticTradeService
    {
        ...
        public List<DTBookingFeeList> GetDTOrderFeeList(Guid orderID, Guid companyID)
        {
            ...
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetInternalOrderFeeList");
                ...
                List<DTBookingFeeList> results = (from b in ds.Tables[0].AsEnumerable()
                                                  select new DTBookingFeeList
                                                  {
                                                      ID = b.Field<Guid>("ID"),
        ...
        /// 保存订单费用
        /// </summary>
        /// <param name="feeInfo">订单ID</param>
        /// <returns>返回ManyResult</returns>
        public ManyResult SaveDTOrderFeeList(FeeSaveRequest feeInfo)
        {
            ...
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspSaveInternalOrderFeeList");
        ...
        public void RemoveDTOrderFeeList(
            ...
            DateTime?[] updateDates)
        {
            ...
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspRemoveInternalOrderFeeInfo");
