...
namespace ICP.FCM.DomesticTrade.ServiceComponent
{
    ...
    public class DTReportDataService : IDTReportDataService
    {
        ...
        public DTReportDataService(IFrameworkInitializeService frameworkInitializeService)
        {
        ...
        /// <returns></returns>
        public DTOrderReportData GetDTOrderReportData(Guid orderID,Guid companyID)
        {
