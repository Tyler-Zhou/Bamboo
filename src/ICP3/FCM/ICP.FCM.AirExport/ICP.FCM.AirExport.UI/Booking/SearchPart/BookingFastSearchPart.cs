...
namespace ICP.FCM.AirExport.UI.Booking
{
    ...
    public class BookingFastSearchPart : FastSearchPart
    {
        public override object GetData()
        {
            try
            {
                List<AirBookingList> list = AirExportService.GetAirBookingListForFaster(CompanyIDs
            ...
            {
                LocalCommonServices.ErrorTrace.SetErrorInfo(FindForm(), ex.Message); return null;
            }
        }
