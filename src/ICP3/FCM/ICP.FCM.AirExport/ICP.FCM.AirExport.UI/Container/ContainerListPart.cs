...
namespace ICP.FCM.AirExport.UI.Container
{
    ...
    public partial class ContainerListPart : BaseEditPart
    {
        ...
        public AWBType BLSourceType { get; set; }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (Saved != null) Saved(new object[] { _OrgData });
        ...
        private void AddData()
        {
            ...
            newData.Weight = 0m;
            newData.BLID = ArgumentHelper.GuidIsNullOrEmpty(MBLID) ? HBLID : MBLID;
        ...
        private void barDelete_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (XtraMessageBox.Show(LocalData.IsEnglish ? "Srue Delete Selected?" : "是否删除选中箱?",
        ...
        private void gvCtn_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
        ...
        private void txtFind_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            txtFind.Text = string.Empty;
        }
