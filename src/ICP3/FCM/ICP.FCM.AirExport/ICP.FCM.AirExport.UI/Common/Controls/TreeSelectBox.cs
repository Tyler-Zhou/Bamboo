...
{
    public partial class TreeSelectBox : XtraUserControl
    {
        #region init
        ...
        public Guid EditValue
        {
            ...
            set
            {
                ...
                if (DesignMode || source == null || source.Count == 0)
                {
                    return;
                }
        ...
        public override string Text
        {
            ...
            set
            {
                ...
                if (DataBindings["EditText"] != null)
                {
                    DataBindings["EditText"].WriteValue();
                }
            }
        }
        ...
        private List<TreeSelectSource> BulidDataSource<T>(List<T> source, string displayMember, string permissionKey)
        {
            ...
            TreeSelectSource topTs = treeSources.Find(delegate(TreeSelectSource item) { return ArgumentHelper.GuidIsNullOrEmpty(item.ParentID); });
        ...
        public void ShowSelectedValue(Guid guid, string p)
        {
            ...
            if (DataBindings["EditValue"] != null)
            {
                DataBindings["EditValue"].DataSourceUpdateMode = DataSourceUpdateMode.OnPropertyChanged;
            }
        }
    }
