    ...
    partial class AirExportService
    {
            ...
            List<CargoSaveRequest> cargos, List<POSaveRequest> pos, PoItemContainersRelationSaveRequest relations)
        {
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, option))
            {
                ...
                if (containers != null)
                {
                    ...
                    {
                        ManyResult temp = this.SaveAirContainerInfo(saveRequest);
                ...
                if (cargos != null)
                {
                    foreach (CargoSaveRequest saveRequest in cargos)
                    {
                        ...
                        result.Add(saveRequest.RequestId,
                            new SaveResponse { RequestId = saveRequest.RequestId, ManyResult = this.SaveAirMBLContainerCargoInfo(saveRequest) });
                    }
                }
                ...
                //    {
                //        HierarchyManyResult temp = this.SaveAirOrderPOInfo(saveRequest);
                ...
                if (relations != null)
                {
                    this.SaveAirContainerPOInfo(relations.poContainerIds, relations.poIds, relations.saveByID);
                    this.SaveAirContainerPOItemInfo(relations.itemContainerIds, relations.itemIds, relations.saveByID);
                }
        ...
        public CompositeContainerObjects GetCompositeContainerObjects(Guid bookingID)
        {
            ...
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetAirLoadContainerList");

                db.AddInParameter(dbCommand, "@AirBookingID", DbType.Guid, bookingID);
                ...
                result.CargoList = (from b in ds.Tables[2].AsEnumerable()
                                    ...
                                    {
                                        ID = b.Field<Guid>("ID"),
                                        AirContainerID = b.Field<Guid>("AirContainerID"),
        ...
        public List<AirContainerList> GetAirContainerList(Guid bookingID)
        {
            ArgumentHelper.AssertGuidNotEmpty(bookingID, "bookingID");
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetAirContainerList");
                ...
                List<AirContainerList> results = (from b in ds.Tables[0].AsEnumerable()
                                                    select new AirContainerList
                                                    {
                                                        ID = b.Field<Guid>("ID"),
                                                        ArriveDate = b.Field<DateTime?>("ArriveDate"),
        ...
        public ManyResult SaveAirContainerInfo(ContainerSaveRequest containerSaveRequest
            )
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("[fcm].[uspSaveAirContainerInfoForTruckService]");
                ...
                db.AddInParameter(dbCommand, "@AirBookingID", DbType.Guid, containerSaveRequest.oceanBookingID);
        ...
        public void RemoveAirContaierInfo(
           Guid[] ids,
           Guid removeByID,
            DateTime?[] updateDates)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspRemoveAirContainerInfo");
        ...
        public void RemoveAirContainerPOInfo(
            Guid id,
            Guid removeByID,
            DateTime? updateDate)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspRemoveAirContainerPOInfo");
        ...
        /// <param name="updateDates">更新时间-做数据版本用</param>
        /// <returns>返回ManyResult</returns>
        public HierarchyManyResult SaveAirContainerPOInfo(ContainerPOSaveRequest containerPOSaveRequest)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspSaveAirContainerPOInfo");
        ...
        public CompositePoAndItems GetAirContainerPOList(Guid bookingId)
        {
            ArgumentHelper.AssertGuidNotEmpty(bookingId, "bookingId");
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetAirContainerPOList");
                ...
                result.POContainerRelationsList = (from p in ds.Tables[1].AsEnumerable()
                                                         ...
                                                         {
                                                             ContainerId = p.Column<Guid>("AirContainerId"),
                ...
                result.PoItemContainerRelationsList = (from q in ds.Tables[3].AsEnumerable()
                                                               select new PoItemContainerRelation
                                                               {
                                                                   ...
                                                                   ContainerId = q.Column<Guid>("AirContainerId")
                                                               }).ToList();
        ...
        public void SaveAirContainerPOInfo(Guid[] containerIds, Guid[]  poIds, Guid saveByID)
        {
        ...
        /// <param name="saveById"></param>
        public void SaveAirContainerPOItemInfo(Guid[] containerIds, Guid[] itemIds, Guid saveByID)
        {
            ArgumentHelper.AssertGuidNotEmpty(saveByID, "saveByID");
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspSaveAirContainerPOItemInfo");
        ...
        /// <param name="removeByID">删除人</param>
        public void RemoveAirContainerCargoInfo(
            Guid cargoID,
            Guid removeByID,
            DateTime? updateDate)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspRemoveAirMBLContaierInfo");
        ...
        /// <param name="updateDates">更新时间-做数据版本用</param>
        /// <returns>返回ManyResult</returns>
        public ManyResult SaveAirMBLContainerCargoInfo(CargoSaveRequest cargoSaveRequest
            )
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspSaveAirContainerCargoInfo");
                ...
                ManyResult result = db.ManyResult(dbCommand, new string[] { "ID", "AirMBLID", "UpdateDate" });
        ...
        public List<AirContainerCargoList> GetAirContainerCargoList(Guid containerID)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetAirContainerCargoList");
