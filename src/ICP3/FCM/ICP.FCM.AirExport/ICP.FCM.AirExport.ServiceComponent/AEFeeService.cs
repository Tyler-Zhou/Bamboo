...
namespace ICP.FCM.AirExport.ServiceComponent
{
    partial class AirExportService
    {
        ...
        public List<AirBookingFeeList> GetAirOrderFeeList(Guid orderID, Guid companyID)
        {
            ...
            try
            {
                ...
                return ConvertDataSetToFeeList(ds);
            }
        ...
        private List<AirBookingFeeList> ConvertDataSetToFeeList(DataSet ds)
        {
        ...
        /// 保存订单费用
        /// </summary>
        /// <param name="feeInfo">费用保存信息</param>
        ...
        public void RemoveAirOrderFeeList(Guid[] ids, Guid companyID, Guid removeByID, DateTime?[] updateDates)
        {
