    ...
    partial class OceanImportService
    {
        ...
        public List<OceanImportPOList> GetOIOrderPOList(Guid orderID)
        {
            ...
            try
            {
                ...
                return ConvertDataSetToImportPOList(ds);
            }
        ...
        /// <returns>返回PO列表</returns>
        public List<OceanImportPOList> GetOIOrderPOList(Guid orderID, Guid companyID)
        {
            ArgumentHelper.AssertGuidNotEmpty(orderID, "orderID");
        ...
        private List<OceanImportPOList> ConvertDataSetToImportPOList(DataSet ds)
        {
        ...
        /// 保存PO信息
        /// </summary>
        /// <param name="request">保存PO的时候传递的实体</param>
        /// <returns></returns>
        ...
        public void RemoveOIOrderPOInfo(Guid id, Guid removeByID, DateTime? updateDate)
        {
        ...
        public void RemoveOIOrderPOInfo(Guid id, Guid companyID, Guid removeByID, DateTime? updateDate)
        {
            ArgumentHelper.AssertGuidNotEmpty(id, "ID");
            ArgumentHelper.AssertGuidNotEmpty(removeByID, "removeByID");
