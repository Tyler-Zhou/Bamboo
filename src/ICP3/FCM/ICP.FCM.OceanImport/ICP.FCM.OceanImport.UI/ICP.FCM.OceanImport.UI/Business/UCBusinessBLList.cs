    ...
    public partial class UCBusinessBLList : ICP.Framework.ClientComponents.UIFramework.BasePart
    {
            ...
            if (!LocalData.IsDesignMode)
            {
                this.Disposed += delegate
                {
                    ...
                    this.dxErrorProvider1.DataSource = null;
                        ...
                        this.bsHBLInfo.PositionChanged -= this.bsHBLInfo_PositionChanged;
            ...
            if (hblsSource.Count != 0)
            {
                ...
                if (changedHBLs.Count > 0)
                {
                    ...
                    foreach (OceanBusinessHBLList hbl in hblsSource)
                    {
                        ...
                        string customsDescription = SerializerHelper.SerializeToString<CustomerDescription>(hbl.ShipperDescription==null? new CustomerDescription():hbl.ShipperDescription, true, false);
        ...
        private void barDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    OceanImportService.RemoveOIBookingHBLInfo(hblList.ID, LocalData.UserInfo.LoginID, hblList.UpdateDate);
        ...
        private void bsHBLInfo_PositionChanged(object sender, EventArgs e)
        {
            ...
            if (ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(CurrentRow.ID))
            {
                this.barCtn.Enabled = false;
            }
            else
        ...
        {
            if (CurrentRow == null || ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(CurrentRow.ID))
            {
                return;
            }
