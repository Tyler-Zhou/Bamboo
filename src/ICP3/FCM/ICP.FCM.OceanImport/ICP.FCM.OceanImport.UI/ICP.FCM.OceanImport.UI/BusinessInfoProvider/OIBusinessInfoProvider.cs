...
namespace ICP.FCM.OceanImport.UI.BusinessInfoProvider
{
    public class OIBusinessInfoProvider : IBusinessInfoProvider
    {
        #region 服务注入
        ...
        {
            IReportViewer viewer = OceanImportPrintHelper.PrintBusinessInfo(operationID);
        ...
        private void ShowBussinessCopyReport(object data)
        {
            ...
            OceanImportPrintHelper.PrintBusinessInfoCopy(blID);
        }
