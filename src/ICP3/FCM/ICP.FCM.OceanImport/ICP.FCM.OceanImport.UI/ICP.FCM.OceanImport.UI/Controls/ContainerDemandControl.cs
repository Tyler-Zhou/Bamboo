    ...
    public partial class ContainerDemandControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ContainerDemandControl()
        {
            ...
            if (!LocalData.IsDesignMode)
            {
                ...
                {
                    TextChanged = null;
                    this.txtContainerDemand.Leave -= this.txtContainerDemand_Leave;
                    this.txtContainerDemand.TextChanged -= this.txtContainerDemand_TextChanged;
                    this.xtraTabControl1.CloseButtonClick -= this.xtraTabControl1_CloseButtonClick;
                    this.txtContainerDemand.ButtonClick -= this.buttonEdit1_ButtonClick;
