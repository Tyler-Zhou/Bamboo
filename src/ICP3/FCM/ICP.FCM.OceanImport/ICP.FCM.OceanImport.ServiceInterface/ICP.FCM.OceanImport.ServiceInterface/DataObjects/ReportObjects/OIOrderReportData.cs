//-----------------------------------------------------------------------
// <copyright file="OIOrderReportData.cs" company="LongWin">
...
namespace ICP.FCM.OceanImport.ServiceInterface
{
    ...
    /// </summary>
    [Serializable]
    public class OIOrderReportData
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public OIOrderReportData()
        {
            this.Fees = new List<OIOrderFeeReportData>();
        }
        ...
        /// 订单费用
        /// </summary>
        public List<OIOrderFeeReportData> Fees { get; set; }
    }
    ...
    /// </summary>
    [Serializable]
    public class OIOrderFeeReportData
    {
        /// <summary>
        /// ID
        /// </summary>
