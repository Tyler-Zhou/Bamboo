...
namespace ICP.FCM.DomesticTrade.UI
{
    public class Utility
    {
        ...
        static public  void EnsureDefaultCompanyExists(IUserService userService)
        {
        ...
        /// </summary>
        /// <param name="userService"></param>
        static public void EnsureDefaultDepartmentExists(IUserService userService)
        {
        ...
        public static decimal GetRate(string sourceCurrency, string targetCurrency, DateTime billdate, List<SolutionExchangeRateList> rateList)
        {
            decimal rate = 1m;
        ...
        public static decimal GetRate(Guid sourceCurrencyID, Guid targetCurrencyID, DateTime billdate, List<SolutionExchangeRateList> rateList)
        {
            decimal rate = 1m;
        ...
        public static void BatRegisterPortFinder(List<ButtonEdit> controls, IDataFindClientService DataFindClientService,bool isEnglish)
        {
            foreach (ButtonEdit ctl in controls)
            {
                SetEnterToExecuteOnec(ctl, delegate
                {
                    PortFinderBridge pfbPlaceOfReceipt = new PortFinderBridge(ctl, DataFindClientService, isEnglish);
                });
            }
        }
        ...
        /// <returns>箱号</returns>
        //public static string BulidCtnNOByContainerList(List<DTBLContainerList> ctnList)
        //{
    ...
    public class UIModelHelper
    {
        ...
        public static void SetContainerItem(RepositoryItemImageComboBox cmbEdit)
        {
            cmbEdit.Items.Add(new ImageComboBoxItem("20GP", Guid.NewGuid()));
            cmbEdit.Items.Add(new ImageComboBoxItem("40GP", Guid.NewGuid()));
            cmbEdit.Items.Add(new ImageComboBoxItem("40HQ", Guid.NewGuid()));
            cmbEdit.Items.Add(new ImageComboBoxItem("45HQ", Guid.NewGuid()));
        }
    }
