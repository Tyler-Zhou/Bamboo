    ...
    public partial class OrderFeeEditPart : XtraUserControl, IChildPart
    {
        ...
        public OrderFeeEditPart()
        {
            ...
            {   
                ...
                if (feePartAR != null)
                {
                    feePartAR.DataChanged -= feePart_FeeChanged;
        ...
        {
            List<DTBookingFeeList> list = DataSource as List<DTBookingFeeList>;
            if (list != null)
            {
        ...
        public List<FeeSaveRequest> SaveFee(Guid OrderID,Guid companyID)
        {
            ...
            List<DTBookingFeeList> fees = DataSource as List<DTBookingFeeList>;
            if (fees.Count != 0)
            {
