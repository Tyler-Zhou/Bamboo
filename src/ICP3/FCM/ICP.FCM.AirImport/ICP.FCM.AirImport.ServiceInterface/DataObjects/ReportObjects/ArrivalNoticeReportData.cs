...
namespace ICP.FCM.AirImport.ServiceInterface
{
    ...
    public class ArrivalNoticeData
    {
        ...
        public string ExpressRelease
        {
            get
            {
                ...
                reslut = (this.ReleaseType == FCMReleaseType.Telex && this.OBLReceived == false) ? "EXPRESS RELEASE" : ((this.ReleaseType == FCMReleaseType.Original && this.OBLReceived) ? "Original B/L Received" : "Original B/L Required");
                return reslut;
            }
        }
    ...
    /// <summary>
    /// AIArrivalNoticeReportData
    /// </summary>
    [Serializable]
    public class AIArrivalNoticeReportData
    {
        public AIArrivalNoticeData ArrivalNoticeData { get; set; }

        public List<ArrivalNoticeFee> ArrivalNoticeFees { get; set; }
    }

    [Serializable]
    public class AIArrivalNoticeData : ArrivalNoticeData
    {
        ...
        /// 提货地
        /// </summary>
        public string FreightlocName { get; set; }
        ...
        public string EffctiveStorageDate { get; set; }
