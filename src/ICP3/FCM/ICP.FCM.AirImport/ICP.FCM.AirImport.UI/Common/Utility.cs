...
namespace ICP.FCM.AirImport.UI
{
    public class Utility
    {
        ...
        public static void BatRegisterPortFinder(List<DevExpress.XtraEditors.ButtonEdit> controls, IDataFindClientService DataFindClientService, bool isEnglish)
        {
       ...
       /// <returns></returns>
        ...
        /// <returns></returns>
        public static List<OrganizationList> GetAllCompanyList(IOrganizationService OrganizationService)
        {
