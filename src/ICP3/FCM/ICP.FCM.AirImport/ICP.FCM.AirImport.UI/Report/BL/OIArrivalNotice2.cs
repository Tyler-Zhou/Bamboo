...
namespace ICP.FCM.AirImport.UI.Report
{
    ...
    public partial class OIArrivalNotice2 : CompositeReportViewPart
    {
        ...
        public ICP.Message.ServiceInterface.IMessageService MessageService
        {
            get
            {
                return ServiceClient.GetService<ICP.Message.ServiceInterface.IMessageService>();
            }
        }
        ...
        public OIArrivalNotice2()
        {
            ...
            {
                this._currentBusinessData = null;
                this._currentBusinessInfo = null;
        ...
        void SendNotice()
        {
            ...
            try
            {
                SingleResultData resultData = AIReportDataSrvice.ArrivalNoticeSent(_currentBusinessData.ID, LocalData.UserInfo.LoginID);
        ...
        {
            ArrivalNoticeReportData arrivalNoticeReportData = AIReportDataSrvice.GetArrivalNoticeReportData(_currentBusinessData.ID);
        ...
        private void SendArrivalNoticeMailToSales(string mode)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(email))
                {
                    ...
                    body.Append("Sent Date: " + DateTime.Now.ToString("MMM,dd.yyyy", System.Globalization.DateTimeFormatInfo.InvariantInfo) + System.Environment.NewLine);
        ...
        public override void Init(IDictionary<string, object> values)
        {
            ...
            _currentBusinessData = ICP.FCM.Common.UI.FCMUIUtility.GetValue("AirBusinessList", values) as AirBusinessList;
            if (_currentBusinessData != null)
            {
                _currentBusinessInfo = AirImportService.GetBusinessInfo(_currentBusinessData.ID);
            }
        }
