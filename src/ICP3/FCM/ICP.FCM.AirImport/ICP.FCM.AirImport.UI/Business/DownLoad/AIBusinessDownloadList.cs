...
namespace ICP.FCM.AirImport.UI
{
    public partial class OIBusinessDownloadList : ICP.Framework.ClientComponents.UIFramework.BaseListPart
    {
        ...
        public void Command_DownLoad(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (new CursorHelper(Cursors.WaitCursor))
                {
                    ...
                    {
                        List<AirBusinessList> oiList = AirImportService.DownLoadBusinessFromDispatchFile(mblIDList.ToArray(), consineeIDList.ToArray(), detas.ToArray(), hblIDList.ToArray(), LocalData.UserInfo.LoginID,null);
        ...
        /// 保存后刷新列表
        /// </summary>
        private void RefreshList(List<AirBusinessList> oiList)
        {
