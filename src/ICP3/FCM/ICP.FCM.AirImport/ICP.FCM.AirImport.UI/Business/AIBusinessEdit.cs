...
namespace ICP.FCM.AirImport.UI
{
    ...
    public partial class OIBusinessEdit : BaseEditPart
    {
        ...
        /// 邮件中心与ICP业务关联信息
        /// </summary>
        ICP.Operation.Common.ServiceInterface.BusinessOperationParameter _businessOperationParameter = null;
        #endregion
        ...
        {
            this._businessInfo = AirImportService.GetBusinessInfoByEdit(businessId);
        }
        ...
        void ShowBusiness()
        {
            ...
            if (ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(_businessInfo.CustomerID) == false)
            {
        ...
        private void InitMBLControl()
        {
            ...
            //MBL运输条款
            if (ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(_businessInfo.ID))
            {
                List<TransportClauseList> transportClauses = ICPCommUIHelper.SetCmbTransportClause(cmbMBLTransportClause);
        ...
        void SearchRegister()
        {
            ...
            //仓库
            this.DataFindClientService.Register(this.cmbWareHouse, CommonFinderConstants.CustoemrFinder,
            ...
            //报关行
            this.DataFindClientService.Register(this.cmbCustoms, CommonFinderConstants.CustoemrFinder,
                SearchFieldConstants.CodeName, SearchFieldConstants.ResultValue,
            ...
            //MBL提货地
            this.DataFindClientService.Register(this.stxtFinalWareHouse, CommonFinderConstants.CustoemrFinder,
                SearchFieldConstants.CodeName, SearchFieldConstants.ResultValue,
            ...
            //PortFinderBridge pfbPOL = new PortFinderBridge(this.stxtDeparture, this.DataFindClientService, true);

            //PortFinderBridge pfbPOD = new PortFinderBridge(this.stxtDetination, this.DataFindClientService, true);
        ...
        void SetLazyLoaders()
        {
            ...
            ////运输条款
            if (ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(_businessInfo.ID) == false)
            {
            ...
            //{
            ICPCommUIHelper.SetComboxByEnum<FCMReleaseType>(this.cmbReleaseType, false);
            //});    
            ...
            #region 代理
            if (ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(_businessInfo.AgentID) == false)
            {
            ...
            Utility.SetEnterToExecuteOnec(stxtMBLNo, delegate
            {
                ...
                //{
                _mblNoList = AirImportService.GetAIMBLList();
        ...
        void treeBoxSalesDep_Enter(object sender, EventArgs e)
        {
            ...
            if (ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(_businessInfo.SalesID) == false)
            {
        ...
        private void SetAgentSource(List<CustomerList> agentCustomers)
        {
            ...
            if (ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(_businessInfo.AgentID))
            {
        ...
        {
            if (ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(this._businessInfo.ConsigneeID))
            {
        ...
        private void stxtMBLNo_EditValueChanged(object sender, EventArgs e)
        {
            ...
            if (curruntNo != this._businessInfo.MBLInfo.MBLNo)
            {
                ...
                if (mbl != null)
                {
                    mbl = AirImportService.GetAIMBLInfo(mbl.ID);
                    if (mbl != null)
                    {
                        this._businessInfo.MBLInfo = mbl;
                        this.bsMBLInfo.DataSource = this._businessInfo.MBLInfo;
        ...
        {
            if (ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(this._businessInfo.ID))
            {
        ...
        void cmbCustomerService_Enter(object sender, EventArgs e)
        {
            ...
            ICPCommUIHelper.SetComboxUsersByRole(cmbCustomerService, depID, "客服", false);
        ...
        void cmbFile_Enter(object sender, EventArgs e)
        {
            ...
            ICPCommUIHelper.SetComboxUsersByRole(cmbFile, depID, "文件", false);
        ...
        void cmbCompany_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this._shown)
            {
                ...
                //值改变时需要刷新[文件和客服]下拉框。
                if (!string.IsNullOrEmpty(cmbFile.Text) && !string.IsNullOrEmpty(cmbCustomerService.Text))
                {
                    ICPCommUIHelper.SetComboxUsersByRole(cmbFile, (Guid)cmbCompany.EditValue, "文件", true);
                    ICPCommUIHelper.SetComboxUsersByRole(cmbCustomerService, (Guid)cmbCompany.EditValue, "客服", true);
                }
                ////值改变时，绑定揽货人
        ...
        private void SetSalesTypeByCustomerAndCompany()
        {
            ...
            {
                DataDictionaryInfo salesType = AirImportService.GetSalesType(_businessInfo.CustomerID, _businessInfo.CompanyID);
                if (salesType != null)
                {
        ...
        private void SetRecentlyOrderListByCustomerAndCompany()
        {
            ...
            {
                bsRecentTenOrders.Clear();
                List<AirOrderInfo> orderList = AirImportService.GetAIRecentlyOrderList(_businessInfo.CompanyID, _businessInfo.CustomerID, LocalData.UserInfo.LoginID, 10);
        ...
        private void gvOrders_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                AirBusinessInfo business = AirImportService.GetBusinessInfoByEdit(CurrentBusinessList.ID);
                if (business == null)
                {
                    return;
                }
        ...
        private void SetSalesDepartment()
        {
            ...
            if (!ICP.Framework.CommonLibrary.Helper.ArgumentHelper.GuidIsNullOrEmpty(_businessInfo.SalesID))
            {
        ...
        private bool Save(AirBusinessInfo currentData, bool isSavingAs)
        {
            ...
            try
            {
                AirBookingSaveRequest originalBusiness = SaveBusiness(currentData);

                List<FeeSaveRequest> originalFees = this.UCOIOrderFeeEdit.GetFeeList(currentData.ID,Guid.Empty);

                MBLInfoSaveRequest originalMBL = GetMBLInfo(currentData.ID);
                List<HBLInfoSaveRequest> originalHBLs = UCHBLList.GetHBLSaveInfo();
                Dictionary<Guid, SaveResponse> saved = this.AirImportService.SaveAIBusinessWithTrans(
                    originalBusiness,
                    originalMBL,
                    originalHBLs,
                    originalFees);
        ...
        private void AfterSave()
        {
            ...
            if (Saved != null)
            {
                ...
                {
                    _businessOperationParameter = new ICP.Operation.Common.ServiceInterface.BusinessOperationParameter();
                }

                _businessOperationParameter.Context = GetContext(_businessInfo);

                Saved(new object[] { _businessInfo, _businessOperationParameter, _businessOperationParameter.Context, this.UCHBLList.GetHBLNo(), this.UCHBLList.GetReceiverState() });
        ...
        private AirBookingSaveRequest SaveBusiness(AirBusinessInfo currentData)
        {
            this.EndEdit();

            AirBookingSaveRequest saveRequest = new AirBookingSaveRequest();
        ...
        void RefreshUI(AirBookingSaveRequest saveRequest)
        {
            SingleResult result = saveRequest.SingleResult;
        ...
        private void barReturn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (_businessInfo.State == AIOrderState.NewOrder)
            {
                ...
                {
                    SingleResultData result = AirImportService.ChangeAIOrderState(_businessInfo.ID,Guid.Empty, AIOrderState.Rejected, returnOrder.ReturnRemark, LocalData.UserInfo.LoginID, _businessInfo.UpdateDate);
        ...
        private void barAuditor_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                try
                {
                    SingleResultData result = AirImportService.ChangeAIOrderState(_businessInfo.ID,Guid.Empty, AIOrderState.Checked, memoContentForm.Memo, LocalData.UserInfo.LoginID, _businessInfo.UpdateDate);
        ...
        private void barPrintProfit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            ProfitReportData data = AIReportDataService.GetProfitReportData(_businessInfo.ID);
            if (data == null) return;
        ...
        {
            this.SmartPartClosing -= BusinessBaseEditPart_SmartPartClosing;
            ...
            this.stxtMBLNo.EditValueChanged -= this.stxtMBLNo_EditValueChanged;
            this.stxtNotifyParty.OnOk -= this.stxtNotifyParty_OnOk;
            this.stxtPlaceOfDelivery.TextChanged -= this.stxtPlaceOfDelivery_TextChanged;
            this.stxtDetination.TextChanged -= this.stxtPOD_TextChanged;
            this.stxtShipper.OnOk -= this.stxtShipper_OnOk;

            this._businessInfo = null;
            this._countryList = null;
            this._mblNoList = null;
            this._weightUnits = null;
            this.Saved = null;
            this.gridControl1.DataSource = null;
            this.bsBusiness.DataSource = null;
            this.bsBusiness.BindingComplete -= this.bsBusiness_BindingComplete;
            this.bsBusiness.Dispose();
            this.bsMBLInfo.DataSource = null;
            this.bsMBLInfo.Dispose();
            this.bsRecentTenOrders.DataSource = null;
            this.bsRecentTenOrders.Dispose();
            if (Workitem != null)
            {
        ...
        public override void Init(IDictionary<string, object> values)
        {
            ...
            foreach (var item in values)
            {
                ...
                {
                    _businessOperationParameter = item.Value as ICP.Operation.Common.ServiceInterface.BusinessOperationParameter;
                    break;
        ...
        /// <returns></returns>
        private BusinessOperationContext GetContext(AirBusinessInfo orderInfo)
        {
            ...
            context.OperationType = ICP.Framework.CommonLibrary.Common.OperationType.AirImport;
