...
namespace ICP.FCM.AirImport.UI
{
    ...
    public partial class OIBusinessTransfer : BaseEditPart
    {
        ...
        private void InitControls()
        {
            ...
            bsInfo = AirImportService.GetBusinessInfo(BusinessID);
            ...
            {
                mblInfo = AirImportService.GetAIMBLInfo(bsInfo.MBLID.Value);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SingleResult singleResult=AirImportService.TransferBusiness(BusinessID, newCompanyID, LocalData.UserInfo.LoginID, bsInfo.UpdateDate);
