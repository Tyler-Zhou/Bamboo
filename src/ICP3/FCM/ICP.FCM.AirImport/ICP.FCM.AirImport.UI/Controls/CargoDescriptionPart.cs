    ...
    public partial class CargoDescriptionPart : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public CargoDescriptionPart()
        {
            ...
            this.Disposed += delegate {
                this._cargoDescription = null;
                this._descriptionTextBox = null;
                this._TopParentControl = null;
                this._weightUnitsList = null;
                if (this._parentControl != null)
                {
                    this._parentControl.Leave -= this._parentControl_Leave;
        ...
        protected List<ICP.Common.ServiceInterface.DataObjects.DataDictionaryList> _weightUnitsList = null;
        public  void SetWeightUnits(List<ICP.Common.ServiceInterface.DataObjects.DataDictionaryList> weightUnitsList) { _weightUnitsList = weightUnitsList; }
