...
namespace ICP.FCM.AirImport.UI
{
    ...
    public partial class OIOrderListPart : ICP.Framework.ClientComponents.UIFramework.BaseListPart
    {
        ...
        /// <param name="e"></param>
        [CommandHandler(OIOrderCommandConstants.Command_AddAIData)]
        public void Command_AddData(object sender, EventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                PartLoader.ShowEditPart<OIOrderBaseEdit>(Workitem, null, string.Empty, EditPartSaved);
            }
        }
        ...
        public void Command_CopyData(object sender, EventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                //AirOrderInfo newData = AirImportService.GetAIOrderInfo(CurrentRow.ID);
                ...
                PartLoader.ShowEditPart<OIOrderBaseEdit>(Workitem, CurrentRow, string.Empty, EditPartSaved);
            }
        }
        /// <summary>
        /// 取消
        ...
        public void Command_CancelData(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (isOK)
                {
                    SingleResult result = AirImportService.CancelAIOrder(CurrentRow.ID,CurrentRow.CompanyID, isCancel, LocalData.UserInfo.LoginID, CurrentRow.UpdateDate);
        ...
        public void Command_Print(object sender, EventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                try
                {
                    IReportViewer viewer = AirImportPrintHelper.PrintOIOrder(CurrentRow.ID, CurrentRow.CompanyID);
                    if (viewer == null)
                    {
                        return;
                    }
        ...
        public void Command_RefreshData(object sender, EventArgs e)
        {
            try
            {
                ...
                List<AirOrderList> list = AirImportService.GetAIOrderListByIds(ids.ToArray(), companyIDs.ToArray());
        ...
        //{
        //    AirOrderList currentRow = Current as AirOrderList;
        //    if (currentRow == null) return;

        //    ConfirmBookingForm memoContentForm = Workitem.Items.AddNew<ConfirmBookingForm>();
        //    memoContentForm.Text = LocalData.IsEnglish ? "Risk Clients" : "确认订舱";
        ...
        //    try
        //    {
        //        SingleResultData result = AirImportService.ChangeOIOrderState(currentRow.ID, AIOrderState.BookingConfirmed, memoContentForm.Memo, LocalData.UserInfo.LoginID, currentRow.UpdateDate);
        //        currentRow.State = AIOrderState.BookingConfirmed;
        ...
        //    ConfirmBookingForm memoContentForm = Workitem.Items.AddNew<ConfirmBookingForm>();
        //    memoContentForm.Text = LocalData.IsEnglish ? "Risk Clients" : "确认装船";
        ...
        //    try
        //    {
        //        SingleResultData result = AirImportService.ChangeOIOrderState(currentRow.ID, AIOrderState.LoadVoyage, memoContentForm.Memo, LocalData.UserInfo.LoginID, currentRow.UpdateDate);
        //        currentRow.State = AIOrderState.LoadVoyage;
        //        currentRow.UpdateDate = result.UpdateDate;
        //        bsList.ResetCurrentItem();
