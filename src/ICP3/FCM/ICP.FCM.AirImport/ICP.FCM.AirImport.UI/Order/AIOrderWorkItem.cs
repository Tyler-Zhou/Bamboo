    ...
    public class OIOrderWorkitem : WorkItem
    {
        ...
        private void Show()
        {
            ...
            if (mainSpce == null)
            {
                ...
                IWorkspace EventListWorkspace = (IWorkspace)this.Workspaces[OIOrderWorkSpaceConstants.EventListWorkspace];
            ...
            _mainListPart.CurrentChanged += delegate(object sender, object data)
            {
                ...
                if (listData != null)
                {
                    BusinessOperationContext context = new BusinessOperationContext
                    {
                        ...
                        FormId = listData.ID,
                        FormType = ICP.Framework.CommonLibrary.Common.FormType.Booking,
                        OperationType = ICP.Framework.CommonLibrary.Common.OperationType.AirImport
                    };
