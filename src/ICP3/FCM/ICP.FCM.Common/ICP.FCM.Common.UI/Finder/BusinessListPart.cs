...
namespace ICP.FCM.Common.UI.Finder
{
    ...
    public partial class BusinessListPart : ICP.Framework.ClientComponents.UIFramework.BaseListPart
    {
        ...
        {
            //OrderState
            List<ICP.Framework.CommonLibrary.Helper.EnumHelper.ListItem<OrderState>> orderStates = ICP.Framework.CommonLibrary.Helper.EnumHelper.GetEnumValues<OrderState>(LocalData.IsEnglish);
            rcmbState.BeginUpdate();
            foreach (var item in orderStates)
            {
                rcmbState.Items.Add(new DevExpress.XtraEditors.Controls.ImageComboBoxItem(item.Name, item.Value));
            }
            rcmbState.EndUpdate();
        ...
        private void gvMain_RowStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowStyleEventArgs e)
        {
            ...
            if (list.State == OrderState.NewOrder)
            {
            ...
            else if (list.State == OrderState.Checked)
            {
            ...
            else if (list.State == OrderState.Rejected)
            {
