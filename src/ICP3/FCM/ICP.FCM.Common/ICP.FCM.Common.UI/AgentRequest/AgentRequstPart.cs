...
{  
    ...
    public partial class AgentRequstPart : BaseEditPart
    {
        ...
        #region IPart 成员
        ICP.Framework.CommonLibrary.Common.OperationType bussinessType = ICP.Framework.CommonLibrary.Common.OperationType.OceanExport;
        public override void Init(IDictionary<string, object> values)
        {
            ...
            foreach (var item in values)
            {
                ...
                {
                    bussinessType = (ICP.Framework.CommonLibrary.Common.OperationType)Enum.Parse(typeof(ICP.Framework.CommonLibrary.Common.OperationType), item.Value.ToString());
                }
            }
        }
        #endregion
