...
{
    [SmartPart]
    public partial class OIDispachCompareBasePart : ICP.FCM.Common.UI.Document.DispatchDocumentCompareBase
    {   
        [ServiceDependency]
        ...
        public OIDispachCompareBasePart()
        {
            InitializeComponent();

            this.Load += delegate
            {
                profitComparePart1.Init(NewOperationID, OldOperationID, OperationType.OceanImport);
            };
        ...
        public override void InnerInitData()
        {
            ...
            //dispatchCompareObject.OEBookingInfo = oiService.GetCompareBusinessInfo(OEOperationID, OIOperationID, OceanBusinessDownLoadList.PlaceofdeliveryDates, OceanBusinessDownLoadList.ConsigneeID);
            dispatchCompareObject.OEBookingInfo = oiService.GetCompareBusinessInfo(NewOperationID, OldOperationID, null, Guid.Empty);
            //var ss= dispatchCompareObject.OEBookingInfo.OceanMBLs;
            ...
            string OEProfit;
            string OIProfit;
            CurrBill = FCMCommonService.GetCompareBillAndChargeInfo(OldOperationID, OperationType.OceanExport);
