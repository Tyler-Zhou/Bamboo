...
{
    public partial class DispatchDocumentCompareNew : BaseEditPart, IDisposable
    {
        /// <summary>
        /// 工作服务
        /// </summary>
        ...
        /// 文件列表比较控件
        /// </summary>
        public UCDocumentDispatchPartNew ucDocumentDispatchPart1;
        ...
        public DispatchDocumentCompareNew()
        {
            InitializeComponent();
            ...
            this.Disposed += delegate
            {
                ...
                {
                    string exceptionstr = "DispatchDocumentCompareNew():Disposed\r\n" + ex.Message;
        ...
        private void DispatchDocumentCompareNew_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void DispatchDocumentCompareNew_Closing(object sender, FormClosingEventArgs e)
        {
            Workitem.Workspaces.Remove(this.deckWsDocument);
        }
        ...
        private void InnerInitControlAndName()
        {
            ...
            if (CurrDipatchCompareType == DipatchCompareType.OIAccept || CurrDipatchCompareType == DipatchCompareType.OEAccept)
            {
                ...
                this.splitContainerControl2.Panel2.Width = 0;
                this.splitContainerControl2.Panel2.Visible = false;

                //ucDocumentDispatchPart1 = Workitem.SmartParts.AddNew<UCDocumentDispatchPartNew>(Guid.NewGuid().ToString());
                //ucDocumentDispatchPart1.ContextHistory = new BusinessOperationContext() { OperationID = OldOperationID };
                //ucDocumentDispatchPart1.ContextCurrent = new BusinessOperationContext() { OperationID = NewOperationID, State = DocumentState.Dispatched };
        ...
        private BusinessOperationContext GetContext(Guid businessID)
        {
