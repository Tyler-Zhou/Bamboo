...
using ICPEnumHelper = ICP.Framework.CommonLibrary.Helper.EnumHelper;
...
namespace ICP.FCM.Common.UI.Document
{
    ...
    public partial class DocumentListPart : ICP.Framework.ClientComponents.UIFramework.BaseListPart
    {
        ...
        {
            List<ICPEnumHelper.ListItem<FCMDocumentType>> memoTypes = ICPEnumHelper.GetEnumValues<FCMDocumentType>(LocalData.IsEnglish);
        ...
        private void barAdd_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            PartLoader.ShowDialog(ep, "Document");
        }
