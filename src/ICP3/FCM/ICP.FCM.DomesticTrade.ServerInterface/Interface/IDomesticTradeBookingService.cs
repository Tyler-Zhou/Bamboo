namespace ICP.FCM.DomesticTrade.ServiceInterface
{
    ...
    /// 内贸业务订舱服务
    /// </summary>
    [ServiceInfomation("内贸业务订舱服务")]
    [ServiceContract]
    public interface IDomesticTradeBookingService
    {
        /// <summary>
        /// 以事务方式保存订舱单、费用和PO
        /// </summary>
        ...
        [FunctionInfomation]
        [OperationContract]
        Dictionary<Guid, SaveResponse> SaveDTBookingWithTrans(BookingSaveRequest saveRequest,
        ...
        [FunctionInfomation]
        [OperationContract]
        List<DTBookingList> GetDTBookingList(
            Guid[] companyIDs,
            string operationNo,
            string ctnNo,
        ...
        [FunctionInfomation]
        [OperationContract]
        List<DTBookingList> GetDTBookingListByIds(Guid[] bookingIDs, bool IsEnglish);
        ...
        [FunctionInfomation]
        [OperationContract]
        List<DTBookingList> GetDTBookingListForFaster(
            Guid[] companyIDs,
        ...
        [FunctionInfomation]
        [OperationContract]
        DTBookingInfo GetDTBookingInfo(Guid id, bool IsEnglish);
        ...
        [FunctionInfomation]
        [OperationContract]
        SingleResult SaveDTBookingInfo(BookingSaveRequest saveRequest, bool IsEnglish);
