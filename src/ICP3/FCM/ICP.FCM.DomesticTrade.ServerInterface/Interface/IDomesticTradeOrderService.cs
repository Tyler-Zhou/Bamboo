...
namespace ICP.FCM.DomesticTrade.ServiceInterface
{
    ...
    public interface IDomesticTradeOrderService
    {
        ...
        [FunctionInfomation]
        [OperationContract]
        Dictionary<Guid, SaveResponse> SaveDTOrderWithTrans(OrderSaveRequest saveRequest,List<FeeSaveRequest> fees);
        ...
        [FunctionInfomation]
        [OperationContract]
        List<DTOrderList> GetDTOrderListByIds(Guid[] orderIDs,Guid [] companyIDs);
        ...
        [FunctionInfomation]
        [OperationContract]
        DTOrderInfo GetDTOrderInfo(Guid id,Guid companyID);
        ...
        [FunctionInfomation]
        [OperationContract]
        SingleResult SaveDTOrderInfo(OrderSaveRequest saveRequest);
