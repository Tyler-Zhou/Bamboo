namespace ICP.FCM.DomesticTrade.ServiceInterface.DataObjects
{
    ...
    #region  DTBookingList 订舱列表数据对象

    /// <summary>
    /// 订舱列表数据对象
    /// </summary>
    [Serializable]
    public partial class DTBookingList : BaseDataObject
    {
        /// <summary>
        /// 从订舱单列表到编辑界面时
        /// 是新增、编辑还是复制的模式
    ...
    public partial class DTBookingInfo : DTBookingList
    {
    ...
    public class BookingBLInfo
    {
        ...
        /// 提单状态
        /// </summary>
        public DTBLState State { get; set; }
    ...
    public class BookingContainerInfo
    {
        ...
        /// 所属订舱单的GUID
        /// </summary>
        public Guid DTBookingID { get; set; }
