...
namespace ICP.FCM.DomesticTrade.ServiceInterface.DataObjects
{
    ...
    /// </summary>
    [Serializable]
    public partial class DTOrderList : BaseDataObject
    {
        /// <summary>
        /// 从订单列表到编辑界面时
        /// 是新增、编辑还是复制的模式
        ...
        /// 交货地名称
        /// </summary>
        [StringLength(MaximumLength = 100, CMessage = "交货地", EMessage = "PlaceOfDelivery")]
        [Required(CMessage = "交货地", EMessage = "PlaceOfDelivery")]
        ...
        FCMOperationType _DTOperationType;
        /// <summary>
        /// 业务类型
        /// </summary>
        public FCMOperationType DTOperationType
        {
            get
            {
                return _DTOperationType;
            }
            set
            {
                if (_DTOperationType != value)
                {
                    _DTOperationType = value;
                    base.OnPropertyChanged("DTOperationType", value);
                }
            }
        }
    ...
    public partial class DTOrderInfo : DTOrderList
    {
        ...
        /// 贸易条款ID
        /// </summary>
        //[GuidRequired(ErrorMessage = "贸易条款必须填写")]
        ...
        /// 最终目的地ID
        /// </summary>
        //[GuidRequired(ErrorMessage="最终目的地必须填写")]
        ...
        public CargoType? CargoType
        {
            get
            {
                ...
                {
                    return (CargoType)Enum.Parse(typeof(CargoType), CargoDescription.Type.Replace("Cargo", string.Empty));
                }
                return null;
            }
        }
    ...
    /// </summary>
    [Serializable]
    public partial class DTBookingPOList : BaseDataObject
    {
        ...
        List<DTPOItemList> _items;
        /// <summary>
        /// Item列表
        /// </summary>
        public List<DTPOItemList> Items
        {
            get
            {
                return _items;
    ...
    /// </summary>
    [Serializable]
    public partial class DTBookingPOInfo : DTBookingPOList
    {
    }
    ...
    /// </summary>
    [Serializable]
    public partial class DTPOItemList : BaseDataObject
    {
        ...
        /// 海关编码
        /// </summary>
        [StringLength(MaximumLength = 20, CMessage = "海关编码", EMessage = "House")]
    ...
    /// </summary>
    [Serializable]
    public partial class DTPOItemInfo : DTPOItemList
    {
    }
    ...
    /// </summary>
    [Serializable]
    public partial class DTBookingFeeList : BaseDataObject
    {
