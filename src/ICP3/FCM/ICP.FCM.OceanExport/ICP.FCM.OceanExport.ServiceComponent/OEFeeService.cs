...
namespace ICP.FCM.OceanExport.ServiceComponent
{
    partial class OceanExportService
    {
        ...
        public List<OceanBookingFeeList> GetOceanOrderFeeList(Guid orderID, Guid companyID)
        {
            ...
            try
            {
                ...
                {
                    return new List<OceanBookingFeeList>();
                }

                return ConvertTableToOceanBookingFeeList(ds.Tables[0]);
            }
        ...
        private List<OceanBookingFeeList> ConvertTableToOceanBookingFeeList(DataTable dt)
        {
            if (dt == null || dt.Rows.Count <= 0)
                return new List<OceanBookingFeeList>();
            List<OceanBookingFeeList> results = (from b in dt.AsEnumerable()
                                                 select new OceanBookingFeeList
                                                 {
                                                     ID = b.Field<Guid>("ID"),
                                                     BookingFeeID = b.Field<Guid>("BookingFeeID"),
                                                     CurrencyID = b.Field<Guid>("CurrencyID"),
                                                     OceanBookingID = b.Field<Guid>("OceanBookingID"),
                                                     CustomerID = b.IsNull("CustomerID") ? Guid.Empty : b.Field<Guid>("CustomerID"),
        ...
        public ManyResult SaveOceanOrderFeeList(FeeSaveRequest feeInfo)
        {
            ...
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspSaveOceanOrderFeeList");
        ...
        public void RemoveOceanOrderFeeList(Guid[] ids, Guid companyID, Guid removeByID, DateTime?[] updateDates)
        {
            ...
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspRemoveOceanOrderFeeInfo");
