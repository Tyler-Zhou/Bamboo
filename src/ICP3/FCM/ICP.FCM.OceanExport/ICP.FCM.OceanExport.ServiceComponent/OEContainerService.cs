...
using TransactionManager = ICP.Framework.CommonLibrary.Helper.TransactionManager;
...
namespace ICP.FCM.OceanExport.ServiceComponent
{
    partial class OceanExportService
    {
            ...
            List<CargoSaveRequest> cargos, List<SaveRequestPurchaseOrderItem> saveRequestPO)
        {
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, option))
            {
                ...
                if (containers != null)
                {
                    ...
                    {
                        ManyResult temp = SaveOceanContainerInfo4TruckService(saveRequest);
                ...
                if (cargos != null)
                {
                    foreach (CargoSaveRequest saveRequest in cargos)
                    {
                        ...
                        result.Add(saveRequest.RequestId,
                            new SaveResponse { RequestId = saveRequest.RequestId, ManyResult = SaveOceanMBLContainerCargoInfo(saveRequest) });
                    }
                }

                if (saveRequestPO!=null)
                {
        ...
        public CompositeContainerObjects GetCompositeContainerObjects(Guid bookingID)
        {
            ...
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetOceanLoadContainerList");

                db.AddInParameter(dbCommand, "@OceanBookingID", DbType.Guid, bookingID);
                ...
                result.MBLs = (from m in ds.Tables[3].AsEnumerable()
                               select new OceanMBLInfo
                               {
                                   ID = m.Field<Guid>("ID"),
                                   No = m.Field<string>("NO"),
                                   WeightUnitID = m.Field<Guid>("WeightUnitID"),
                                   QuantityUnitID = m.Field<Guid>("QuantityUnitID"),
                                   MeasurementUnitID = m.Field<Guid>("MeasurementUnitID")

                               }).ToList();

                result.HBLs = (from m in ds.Tables[4].AsEnumerable()
        ...
        public List<OceanContainerList> GetOceanContainerList(Guid bookingID)
        {
            ArgumentHelper.AssertGuidNotEmpty(bookingID, "bookingID");
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetOceanContainerList");
                ...
                List<OceanContainerList> results = (from b in ds.Tables[0].AsEnumerable()
                                                    select new OceanContainerList
                                                    {
                                                        ID = b.Field<Guid>("ID"),
                                                        ArriveDate = b.Field<DateTime?>("ArriveDate"),
        ...
        public ManyResult SaveOceanContainerInfo(ContainerSaveRequest containerSaveRequest)
        {
            ...
            ArgumentHelper.AssertArrayLengthMatch(
                 ...
                 containerSaveRequest.containerCTNOpers,
                 containerSaveRequest.containerShippingOrderNos,
                 containerSaveRequest.containerVGMCrossWeights,
                 containerSaveRequest.containerVGMMethods,
                 containerSaveRequest.containerIsSOCs,
                 containerSaveRequest.containerIsPartOfs,
                 containerSaveRequest.containerUpdateDates);

            try
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("[fcm].[uspSaveOceanContainerInfo]");
                ...
                string tempCTNOpers = containerSaveRequest.containerCTNOpers.Join();
                string tempcontainerShippingOrderNos = containerSaveRequest.containerShippingOrderNos.Join();
                string tempVGMCrossWeight = containerSaveRequest.containerVGMCrossWeights.Join();
                string tempVGMMethod = containerSaveRequest.containerVGMMethods.Join();
                string tempIsSOCs = containerSaveRequest.containerIsSOCs.Join();
                string tempIsPartOfs = containerSaveRequest.containerIsPartOfs.Join();
                string tempcontainerUpdateDates = containerSaveRequest.containerUpdateDates.Join();

                db.AddInParameter(dbCommand, "@OceanBookingID", DbType.Guid, containerSaveRequest.oceanBookingID);
                ...
                db.AddInParameter(dbCommand, "@CTNOper", DbType.String, tempCTNOpers);
                db.AddInParameter(dbCommand, "@ShippingOrderNos", DbType.String, tempcontainerShippingOrderNos);
                db.AddInParameter(dbCommand, "@VGMCrossWeight", DbType.String, tempVGMCrossWeight);
                db.AddInParameter(dbCommand, "@VGMMethod", DbType.String, tempVGMMethod);
                db.AddInParameter(dbCommand, "@IsSOCs", DbType.String, tempIsSOCs);
                db.AddInParameter(dbCommand, "@IsPartOfs", DbType.String, tempIsPartOfs);
        ...
        public void RemoveOceanContaierInfo( Guid[] ids, Guid removeByID, DateTime?[] updateDates)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspRemoveOceanContainerInfo");
        ...
        /// <param name="containerSaveRequest">箱保存实体</param>
        /// <returns>返回SingleResult</returns>
        public ManyResult SaveOceanContainerInfo4TruckService(ContainerSaveRequest containerSaveRequest)
        {
            ArgumentHelper.AssertGuidNotEmpty(containerSaveRequest.oceanBookingID, "oceanBookingID");
            ArgumentHelper.AssertGuidNotEmpty(containerSaveRequest.saveByID, "saveByID");
            ArgumentHelper.AssertArrayLengthMatch(
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("[fcm].[uspSaveOceanContainerInfoForTruckService]");
        ...
        /// <param name="updateDates">更新时间-做数据版本用</param>
        /// <returns>返回ManyResult</returns>
        public void RemoveDeclareContaierInfo(
           Guid[] ids,
           Guid removeByID,
            DateTime?[] updateDates)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspRemoveDeclareContainerInfo");
        ...
        public void RemoveOceanContainerPOInfo(
            Guid id,
            Guid removeByID,
            DateTime? updateDate)
        {
        ...
        /// <param name="updateDates">更新时间-做数据版本用</param>
        /// <returns>返回ManyResult</returns>
        public HierarchyManyResult SaveOceanContainerPOInfo(ContainerPOSaveRequest containerPOSaveRequest)
        {
        ...
        public CompositePoAndItems GetOceanContainerPOList(Guid bookingId)
        {
            ArgumentHelper.AssertGuidNotEmpty(bookingId, "bookingId");
        ...
        public void SaveOceanContainerPOInfo(Guid[] containerIds, Guid[]  poIds, Guid saveByID)
        {
        ...
        /// <param name="saveById"></param>
        public void SaveOceanContainerPOItemInfo(Guid[] containerIds, Guid[] itemIds, Guid saveByID)
        {
            ArgumentHelper.AssertGuidNotEmpty(saveByID, "saveByID");
        ...
        /// <param name="removeByID">删除人</param>
        public void RemoveOceanContainerCargoInfo(
            Guid cargoID,
            Guid removeByID,
            DateTime? updateDate)
        {
        ...
        /// <param name="updateDates">更新时间-做数据版本用</param>
        /// <returns>返回ManyResult</returns>
        public ManyResult SaveOceanMBLContainerCargoInfo(CargoSaveRequest cargoSaveRequest
            )
        {
        ...
        {
            TransactionManager.Instance.GetTransactionScope(transactionId).Complete();
        }
        ...
        public List<OceanContainerCargoList> GetOceanContainerCargoList(Guid containerID)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetOceanContainerCargoList");
        ...
        /// <returns></returns>
        public Dictionary<Guid, SaveResponse> SaveOceanContainerList(List<ContainerSaveRequest> containers)
        {
            try
            {
                ...
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, option))
                {
                    ...
                    if (containers != null)
                    {
                        foreach (ContainerSaveRequest saveRequest in containers)
                        {
                            ManyResult temp = SaveOceanContainerInfo(saveRequest);
        ...
        public List<OceanContainerCargoList> GetOceanContainerCargoList(Guid MBLID,Guid? HBLID, FCMBLType fcmBLType)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetOceanDeclareContainerCargoList");
                ...
                List<OceanContainerCargoList> results = (from b in ds.Tables[0].AsEnumerable()
                                                         select new OceanContainerCargoList
                                                         {
                                                             ...
                                                             OceanContainerID = b.Field<Guid>("OceanContainerID"),
                                                             OceanContainerNo = b.Field<string>("OceanContainerNo"),
                                                             Marks = b.Field<string>("Marks"),
                                                             Commodity = b.Field<string>("Commodity"),
        ...
        /// <returns>返回ManyResult</returns>
        public ManyResult SaveOceanDeclarationBLContainerInfo(CargoSaveRequest cargoSaveRequest)
        {
            ArgumentHelper.AssertGuidNotEmpty(cargoSaveRequest.MBLID, "MBLID");
            ArgumentHelper.AssertGuidNotEmpty(cargoSaveRequest.saveByID, "saveByID");
            ArgumentHelper.AssertArrayLengthMatch(
                 cargoSaveRequest.ids,
                 cargoSaveRequest.marks,
                 cargoSaveRequest.commodities,
                 cargoSaveRequest.hscodes,
                 cargoSaveRequest.quantities,
                 cargoSaveRequest.weights,
                 cargoSaveRequest.measurements,
                 cargoSaveRequest.updateDates);

            try
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspSaveOceanDeclarationBLContainerInfo");

                string tempcontainerids = cargoSaveRequest.containerids.Join();
                string tempIds = cargoSaveRequest.ids.Join();
                string tempMarks = cargoSaveRequest.marks.Join();
                string tempCommodities = cargoSaveRequest.commodities.Join();
                string tempHSCodes = cargoSaveRequest.hscodes.Join();
                string tempQuantities = cargoSaveRequest.quantities.Join();
                string tempWeights = cargoSaveRequest.weights.Join(3);
                string tempMeasurements = cargoSaveRequest.measurements.Join(3);
                string tempUpdateDates = cargoSaveRequest.updateDates.Join();

                db.AddInParameter(dbCommand, "@OceanDeclarationBLID", DbType.Guid, cargoSaveRequest.hblids[0]);
                db.AddInParameter(dbCommand, "@OceanContainerIDs", DbType.String, tempcontainerids);
                db.AddInParameter(dbCommand, "@Ids", DbType.String, tempIds);
                db.AddInParameter(dbCommand, "@Marks", DbType.String, tempMarks);
                db.AddInParameter(dbCommand, "@Commodities", DbType.String, tempCommodities);
                db.AddInParameter(dbCommand, "@HSCodes", DbType.String, tempHSCodes);
                db.AddInParameter(dbCommand, "@Quantities", DbType.String, tempQuantities);
                db.AddInParameter(dbCommand, "@Weights", DbType.String, tempWeights);
                db.AddInParameter(dbCommand, "@Measurements", DbType.String, tempMeasurements);
                db.AddInParameter(dbCommand, "@SaveByID", DbType.Guid, cargoSaveRequest.saveByID);
                ...
                ManyResult result = db.ManyResult(dbCommand, new [] { "ID", "UpdateDate" });
        ...
        /// <param name="cargoSaveRequest"></param>
        /// <returns>返回ManyResult</returns>
        public ManyResult SaveOceanDeclarationCargo(CargoSaveRequest cargoSaveRequest)
        {
            ArgumentHelper.AssertGuidNotEmpty(cargoSaveRequest.MBLID, "MBLID");
            ArgumentHelper.AssertGuidNotEmpty(cargoSaveRequest.saveByID, "saveByID");
            ArgumentHelper.AssertArrayLengthMatch(
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspSaveMBLOceanDeclarationBLContainerInfo");

                string temphblids = cargoSaveRequest.hblids.Join();
                string tempcontainerids = cargoSaveRequest.containerids.Join();
                string tempIds = cargoSaveRequest.ids.Join();
                string tempMarks = cargoSaveRequest.marks.Join();
                string tempCommodities = cargoSaveRequest.commodities.Join();
                ...
                db.AddInParameter(dbCommand, "@OceanMBLID", DbType.Guid, cargoSaveRequest.MBLID);
                db.AddInParameter(dbCommand, "@OceanDeclarationBLIDs", DbType.String, temphblids);
                db.AddInParameter(dbCommand, "@OceanContainerIDs", DbType.String, tempcontainerids);
                db.AddInParameter(dbCommand, "@Ids", DbType.String, tempIds);
                db.AddInParameter(dbCommand, "@Marks", DbType.String, tempMarks);
                db.AddInParameter(dbCommand, "@Commodities", DbType.String, tempCommodities);
        ...
        /// <returns></returns>
        public Dictionary<Guid, SaveResponse> SaveOceanDeclarationBLContainerInfoList(List<CargoSaveRequest> cargosSaveRequests)
        {
            try
            {
                TransactionOptions option = new TransactionOptions { IsolationLevel = IsolationLevel.ReadCommitted };
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, option))
                {
                    ...
                    if (cargosSaveRequests != null)
                    {
                        foreach (CargoSaveRequest saveRequest in cargosSaveRequests)
                        {
                            ManyResult temp = SaveOceanDeclarationBLContainerInfo(saveRequest);
                            result.Add(saveRequest.RequestId, new SaveResponse { RequestId = saveRequest.RequestId, ManyResult = temp });
                        }
                    }
                    scope.Complete();
        ...
        /// <param name="updateDates">更新时间-做数据版本用</param>
        /// <returns>返回ManyResult</returns>
        public void RemoveOceanDeclarationBLContainerInfo(Guid[] ids, Guid removeByID, DateTime?[] updateDates)
        {
            ArgumentHelper.AssertGuidNotEmpty(ids, "ids");
            ArgumentHelper.AssertGuidNotEmpty(removeByID, "removeByID");
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspRemoveOceanDeclarationBLContaierInfo");
