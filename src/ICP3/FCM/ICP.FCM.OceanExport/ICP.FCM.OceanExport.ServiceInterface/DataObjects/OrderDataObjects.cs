...
namespace ICP.FCM.OceanExport.ServiceInterface.DataObjects
{
    ...
    public partial class OceanOrderList : BaseDataObject
    {
        ...
        /// 客服ID
        /// </summary>
        [GuidRequired(CMessage = "客服", EMessage = "BookingerName")]
        ...
        /// 订舱员ID
        /// </summary>
        [GuidRequired(CMessage = "订舱员", EMessage = "BookingBy")]
    ...
    public partial class OceanOrderInfo : OceanOrderList
    {
        ...
        /// 船公司ID
        /// </summary>
        [GuidRequired(CMessage = "船公司", EMessage = "Carrier")]
        ...
        #region 费用列表ChargeCode
        /// <summary>
        /// 费用列表选择的ChargeCode
        /// </summary>
        public string ChargeCodeIdstring { get; set; }

        #endregion


        #region 费用列表ChareCode
        ...
        #endregion
        List<OceanBookingFeeList> feeList = new List<OceanBookingFeeList>();
        /// <summary>
        /// 费用列表
        /// </summary>
        public List<OceanBookingFeeList> FeeList
        {
            get
            {
                return feeList;
            ...
            set
            {
                ...
                {
                    feeList = value;
                    base.OnPropertyChanged("FeeList", value);
                }
            }
        }
    ...
    /// </summary>
    [Serializable]
    public partial class AgentFilerList : BaseDataObject
    {
        Guid _customerid;
        /// <summary>
        /// 客户ID
        ...
        public string CustomerEname
        {
            ...
            set
            {
                if (_customerename != value)
                {
                    ...
                    base.OnPropertyChanged("CustomerEname", value);
                }
            }
        ...
        public string CustomerCname
        {
            ...
            set
            {
                if (_customercname != value)
                {
                    ...
                    base.OnPropertyChanged("CustomerCname", value);
                }
            }
        }
        ...
        public string CustomerAddress
        {
            ...
            set
            {
                if (_customeraddress != value)
                {
                    ...
                    base.OnPropertyChanged("CustomerAddress", value);
                }
            }
        ...
        /// 港后客服ID
        /// </summary>
        public Guid AgentFilerID
        {
            get { return _agentfilerid; }
            set
            {
                if (_agentfilerid != value)
                {
                    _agentfilerid = value;
                    base.OnPropertyChanged("AgentFilerID", value);
                }
            }

        }

        string _agentfilername;
        /// <summary>
        ///港后客服名
        /// </summary>
        public string AgentFilerName
        {
            get { return _agentfilername; }
            set
            {
                if (_agentfilername != value)
                {
                    _agentfilername = value;
                    base.OnPropertyChanged("AgentFilerName", value);
                }
            }
        }
