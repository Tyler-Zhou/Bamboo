namespace ICP.FCM.OceanExport.UI
{
    partial class POItemEditPart
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.errorPO = new DevExpress.XtraEditors.DXErrorProvider.DXErrorProvider();
    ...
    "ow.";
            ...
            this.gridViewItem.BeforeLeaveRow += new DevExpress.XtraGrid.Views.Base.RowAllowEventHandler(this.gridViewItem_BeforeLeaveRow);
            ...
            // bindingSource1
            // 
            this.bindingSource1.DataSource = typeof(ICP.FCM.OceanExport.ServiceInterface.DataObjects.OceanBookingPOList);
            // 
            // gridViewPO
            // 
            ...
            // colPODescription
            // 
            this.colPODescription.Caption = "Description";
