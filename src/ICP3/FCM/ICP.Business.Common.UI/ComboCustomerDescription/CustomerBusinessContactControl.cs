...
namespace ICP.Business.Common.UI
{
    ...
    /// 带最近业务和业务联系人的客户编辑控件
    /// </summary>
    public partial class CustomerBusinessContactControl : XtraUserControl
    {
        private bool isFirstTimeEnter = true;
        public EventHandler FirstTimeEnter;
        private Guid customerID;
        private ContactStage contactStage;
        private RecentShipmentPopupContainerControl recentShipmentPopupContainerControl;
        ...
        private void InitPopupControl()
        {
            ...
            {
                this.recentShipmentPopupContainerControl = new RecentShipmentPopupContainerControl();
                this.recentShipmentPopupContainerControl.SelectChanged += new EventHandler<CommonEventArgs<OceanOrderList>>(recentShipmentPopupContainerControl_SelectChanged);
                this.popupContainerEdit.Properties.PopupControl = this.recentShipmentPopupContainerControl;

            }
        }
        public CustomerBusinessContactControl()
        {
            InitializeComponent();
        ...
        void recentShipmentPopupContainerControl_SelectChanged(object sender, CommonEventArgs<OceanOrderList> e)
        {
