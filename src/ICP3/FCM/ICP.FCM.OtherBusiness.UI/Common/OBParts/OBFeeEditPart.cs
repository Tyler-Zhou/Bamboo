...
namespace ICP.FCM.OtherBusiness.UI.Common
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public partial class OBFeeEditPart : XtraUserControl, IChildPart
    {
        #region 服务
        ...
        private void cmbCurrencySelectedIndexChanged(object sender, EventArgs e)
        {
            FeeChangedAmount();
        }
