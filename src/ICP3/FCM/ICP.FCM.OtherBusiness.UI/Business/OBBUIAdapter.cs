 ...
 * Create On:2018/3/25 星期日 16:13:23
 *
 * Description:
 *         ->
 *
...
namespace ICP.FCM.OtherBusiness.UI.Business
{
    ...
    public class OBBUIAdapter //
    {
        ...
        {
            _toolBar = (IToolBar)controls[typeof(OBBMainToolBar).Name];
            _searchPart = (ISearchPart)controls[typeof(OBBSearchPart).Name];
            _mainListPart = (OBBListPart)controls[typeof(OBBListPart).Name];
            _fastSearchPart = (ISearchPart)controls[typeof(OBBFastSearchPart).Name];
