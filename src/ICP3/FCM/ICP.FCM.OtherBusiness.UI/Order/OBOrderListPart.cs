...
namespace ICP.FCM.OtherBusiness.UI.Order
{
    ...
    /// 其他业务-列表
    /// </summary>
    public class OBOrderListPart:OBListPart
    {
        #region 字段 & 属性 & 事件
        /// <summary>
        /// 
        ...
        {
            get { return OBOCommandConstants.Command_EditData; }
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            get { return OBOCommandConstants.Command_ShowSearch; }
        }
        #endregion
        ...
        [CommandHandler(OBOCommandConstants.Command_AddData)]
        public void Command_AddData(object sender, EventArgs args)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                PartLoader.ShowEditPart<OBOrderBaseEditPart>(Workitem, null, LocalData.IsEnglish ? "Add Order" : "新增订单信息", EditPartSaved);
            }
        }
        #endregion
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        [CommandHandler(OBOCommandConstants.Command_CopyData)]
        public void Command_CopyData(object sender, EventArgs e)
        {
            ...
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                PartLoader.ShowEditPart<OBOrderBaseEditPart>(Workitem, CurrentRow, LocalData.IsEnglish ? "Edit Business" : "编辑业务信息", EditPartSaved,
                    OBOCommandConstants.Command_EditData + CurrentRow.ID.ToString());
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        [CommandHandler(OBOCommandConstants.Command_EditData)]
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        [CommandHandler(OBOCommandConstants.Command_RefreshData)]
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        [CommandHandler(OBOCommandConstants.Command_CancelData)]
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        [CommandHandler(OBOCommandConstants.Command_Bill)]
        ...
        [CommandHandler(OBOCommandConstants.Command_VerifiSheet)]
        public void Command_VerifiSheet(object sender, EventArgs e)
        {
            ...
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                PartLoader.ShowEditPart<VerifiSheetEditPart>(Workitem,
                    ...
                    title,
                    null,
                    OBOCommandConstants.Command_VerifiSheet + CurrentRow.ID.ToString());
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        [CommandHandler(OBOCommandConstants.Command_PickUp)]
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        [CommandHandler(OBOCommandConstants.Command_OpContact)]
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        [CommandHandler(OBOCommandConstants.Command_Profit)]
