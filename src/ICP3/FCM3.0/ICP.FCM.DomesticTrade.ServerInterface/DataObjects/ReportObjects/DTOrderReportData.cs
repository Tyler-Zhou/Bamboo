...
namespace ICP.FCM.DomesticTrade.ServiceInterface.DataObjects.ReportObjects
{
    ...
    /// </summary>
    [Serializable]
    public class DTOrderReportData
    {
        /// <summary>
        /// 构造函数        /// </summary>
        public DTOrderReportData()
        {
            this.Fees = new List<DTOrderFeeReportData>();
        }
        ...
        /// 订单费用
        /// </summary>
        public List<DTOrderFeeReportData> Fees { get; set; }
    }
    ...
    /// </summary>
    [Serializable]
    public class DTOrderFeeReportData
    {
        /// <summary>
        /// ID
        /// </summary>
