...
namespace ICP.FCM.AirImport.UI
{
    ...
    public partial class OIOrderListPart : ICP.Framework.ClientComponents.UIFramework.BaseListPart
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            List<AirOrderList> list = oiService.GetAIOrderList(companyIDs.ToArray(),
                                                                            string.Empty,
                                                                            string.Empty,
                                                                            string.Empty,
                                                                            string.Empty,
        ...
        public void Command_CopyData(object sender, EventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                //AirOrderInfo newData = oiService.GetAIOrderInfo(CurrentRow.ID);
        ...
        public void Command_Print(object sender, EventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                try
                {
                    IReportViewer viewer = AirImportPrintHelper.PrintOIOrder(CurrentRow.ID);
                    if (viewer == null)
                    {
                        return;
                    }
        ...
        public void Command_RefreshData(object sender, EventArgs e)
        {
            try
            {
                ...
                List<AirOrderList> list = oiService.GetAIOrderListByIds(ids.ToArray());
        ...
        //    try
        //    {
        //        SingleResultData result = oiService.ChangeOIOrderState(currentRow.ID, AIOrderState.BookingConfirmed, memoContentForm.Memo, LocalData.UserInfo.LoginID, currentRow.UpdateDate);
        ...
        //    try
        //    {
        //        SingleResultData result = oiService.ChangeOIOrderState(currentRow.ID, AIOrderState.LoadVoyage, memoContentForm.Memo, LocalData.UserInfo.LoginID, currentRow.UpdateDate);
