...
namespace ICP.FCM.AirImport.UI.Report
{
    ...
    {
        [ServiceDependency]
        public IAIReportDataService aiReportSrvice { get; set; }
        [ServiceDependency]
        ...
        {
            AirBusinessInfo businessInfo = oiService.GetBusinessInfoByEdit(_currentAirBusinessList.ID);
        ...
        protected override void Query()
        {
            ...
            AIArrivalNoticeReportData arrivalNoticeReportData = aiReportSrvice.GetAuthorityToMakeEntry((Guid)cmbHBLNo.EditValue);
        ...
        {  
            _currentAirBusinessList = ICP.FCM.Common.UI.Utility.GetValue("AirBusinessList", values) as AirBusinessList;
