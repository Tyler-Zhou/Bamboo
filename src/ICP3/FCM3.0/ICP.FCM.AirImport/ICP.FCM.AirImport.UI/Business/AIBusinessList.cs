...
namespace ICP.FCM.AirImport.UI
{
    ...
    public partial class OIBusinessList : ICP.Framework.ClientComponents.UIFramework.BaseListPart
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //List<AirBusinessList> list = oiService.GetBusinessListByFastSearch(
            //                            Utility.GetCompanyIDs(userService),
            //                            OIBusinessNoSearchType.All,
            //                            string.Empty,
            //                            OIBusinessCustomerSearchType.All,
            //                            string.Empty,
            //                            OIBusinessPortSearchType.All,
            //                            string.Empty,
            //                            OIBusinessDateSearchType.All,
            //                            null,
            //                            null,
        ...
        public void Command_AddData(object sender, EventArgs e)
        {
            ...
            {
                Utility.ShowEditPart<OIBusinessEdit>(Workitem, null, "新增空运进口业务", EditPartSaved);
            }
        }
        ...
        public void Command_CopyData(object sender, EventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                AirBusinessInfo newData = oiService.GetBusinessInfo(CurrentRow.ID);
                ...
                Utility.ShowEditPart<OIBusinessEdit>(Workitem, newData, "新增空运进口业务", EditPartSaved);
            }
        }
        #endregion
        ...
        public void Command_EditData(object sender, EventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                Utility.ShowEditPart<OIBusinessEdit>(Workitem, CurrentRow, "编辑空运进口业务", EditPartSaved);
            }
        }
        ...
        public void Command_Bill(object sender, EventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                OperationCommonInfo operationCommonInfo = fcmCommonService.GetOperationCommonInfo(CurrentRow.ID, ICP.Framework.CommonLibrary.Common.OperationType.AirImport);
        ...
        public void Command_PrintArrivalNotice(object sender, EventArgs e)
        {
            ...
            if (CurrentRow.IsSentAN == false && (CurrentRow.SalesID == null || CurrentRow.SalesID == Guid.Empty))
            {
            ...
            stateValues.Add("AirBusinessList", CurrentRow);
        ...
        public void Command_PrintProfit(object sender, EventArgs e)
        {
            ...
            try
            {
                IReportViewer viewer = AirImportPrintHelper.PrintProfit(CurrentRow.ID);
                if (viewer == null)
                {
                    return;
                }
        ...
        public void Command_CancelData(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (isOK)
                {
                    SingleResult result = oiService.CancelAIOrder(CurrentRow.ID, isCancel, LocalData.UserInfo.LoginID, CurrentRow.UpdateDate);
        ...
        public void Command_RefreshData(object sender, EventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                try
                {
                    ...
                    List<AirBusinessList> list = oiService.GetBusinessListByIds(ids.ToArray());
        ...
        public void Command_Delivery(object sender, EventArgs e)
        {
            ...
            if (CurrentRow.State != AIOrderState.Release)
            {
                #region 放货
            ...
            else
            {
                ...
                if (isOK)
                {
                    try
                    {
                        SingleResultData result = oiService.ChangeAIOrderState(CurrentRow.ID, AIOrderState.Checked, string.Empty, LocalData.UserInfo.LoginID, CurrentRow.UpdateDate);
                        CurrentRow.State = AIOrderState.Checked;
        ...
        private void EditPartSaved(object[] prams)
        {
            ...
            data.OBLRcved = Convert.ToBoolean(prams[2]);
        ...
        private void TruckEditPartSaved(object[] prams)
        {
            Guid[] ids = new Guid[1];
            ids[0] = CurrentRow.ID;
            List<AirBusinessList> datas = oiService.GetBusinessListByIds(ids);
