    ...
    public partial class UCBusinessBLList : ICP.Framework.ClientComponents.UIFramework.BasePart
    {
        ...
        IAirImportService oIService
        {
            get
            {
                ...
                {
                    return Workitem.Services.Get<IAirImportService>();
                }
            }
        }
        ...
        private void barDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    oIService.RemoveAIBookingHBLInfo(hblList.ID, LocalData.UserInfo.LoginID, hblList.UpdateDate);
