...
namespace ICP.FCM.AirImport.UI.Controls
{
    ...
    public partial class FeePart : DevExpress.XtraEditors.XtraUserControl, IChildPart
    {
        ...
        IAirImportService AirImportService { get { return Workitem.Services.Get<IAirImportService>(); } }
        ...
        private void barDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    AirImportService.RemoveAIOrderFeeList(needRemoveIDs.ToArray(), LocalData.UserInfo.LoginID, needRemoveUpdateDate.ToArray());
                }
