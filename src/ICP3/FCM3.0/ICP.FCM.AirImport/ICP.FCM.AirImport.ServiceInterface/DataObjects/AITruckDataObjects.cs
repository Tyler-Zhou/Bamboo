...
namespace ICP.FCM.AirImport.ServiceInterface
{
    ...
    /// </summary>
    [Serializable]
    public partial class AirImportTruckList : BaseDataObject
    {
        /// <summary>
        /// IsNew
        /// </summary>
    ...
    /// </summary>
    [Serializable]
    public partial class AirImportTruckInfo : AirImportTruckList
    {
        ...
        public string PickUpRefNo
        {
            ...
            set
            {
                if (_pickUpRefNo != value)
                {
                    _pickUpRefNo = value;
                    base.OnPropertyChanged("PickUpRefNo", value);
                }
            }
        }
        #endregion
        ...
        public string PickUpContact
        {
            ...
            set
            {
                if (_pickUpContact != value)
                {
                    _pickUpContact = value;
                    base.OnPropertyChanged("PickUpContact", value);
                }
            }
        }
        ...
        public string DeliveryNo
        {
            ...
            set
            {
                ...
                {
                    _deliveryNo = value;
                    base.OnPropertyChanged("DeliveryNo", value);
                }
            }
        }
        ...
        public string DeliveryContact
        {
            ...
            set
            {
                if (_deliveryContact != value)
                {
                    ...
                    base.OnPropertyChanged("DeliveryContact", value);
                }
            }
        }
