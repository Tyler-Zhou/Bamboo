...
namespace ICP.FCM.DomesticTrade.UI
{
    ...
    public partial class BookingSearchPart : ICP.Framework.ClientComponents.UIFramework.BaseSearchPart
    {
        ...
        private void InitControls()
        {
            ...
            {
                ICPCommUIHelperService.BindCustomerList(this.mcmbCarrier, CustomerType.Carrier);
            });
        ...
        protected virtual void SetState()
        {
            ...
            if (SearchOrderState == null) cmbState.Properties.Items.Add(new DevExpress.XtraEditors.Controls.ImageComboBoxItem(LocalData.IsEnglish ? "ALL" : "全部", System.DBNull.Value));
        ...
        public DTOrderState? OrderStateValue
        {
            get
            {
                ...
                if (cmbState.EditValue != null && cmbState.EditValue != System.DBNull.Value) return (DTOrderState)cmbState.EditValue;
                else return null;
            }
        }
