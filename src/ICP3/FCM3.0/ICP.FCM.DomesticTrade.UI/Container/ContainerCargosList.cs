...
namespace ICP.FCM.DomesticTrade.UI.Container
{
    ...
    public partial class ContainerCargosList : BaseEditPart
    {
        ...
        //IFrameworkSystemService systemService { get { return this.Workitem.Services.Get<IFrameworkSystemService>(); } }
        ...
        void InitControls()
        {
            ...
            //{
            ICPCommUIHelperService.SetCmbDataDictionary(this.rcmbQuantityUnit, DataDictionaryType.QuantityUnit);
            //});

            ////重量
            //Utility.SetEnterToExecuteOnec(this.rcmbWeightUnit, delegate
            //{
            ICPCommUIHelperService.SetCmbDataDictionary(rcmbWeightUnit, DataDictionaryType.WeightUnit);
            //});

            ////体积
            //Utility.SetEnterToExecuteOnec(rcmbMeasurementUnit, delegate
            //{
            ICPCommUIHelperService.SetCmbDataDictionary(rcmbMeasurementUnit, DataDictionaryType.MeasurementUnit);
            //});
        }
        ...
        DTContainerCargoList CurrentRow
        {
            get
            {
                return this.bsContainerCargo.Current as DTContainerCargoList;
            }
        }
        ...
        public bool IsChanged
        {
            ...
            {
                this.gvCargo.CloseEditor();
                foreach (DTContainerCargoList item in this._allCargos)
                {
                    if (item.IsDirty)
                    {
                        return true;
        ...
        {            
            ...
            {
                DTContainerCargoList cargo = this.bsContainerCargo.Current as DTContainerCargoList;
        ...
        public List<CargoSaveRequest> CollectCargosData()
        {
            ...
            List<DTContainerCargoList> listChangedCargos = this._allCargos.FindAll(o => o.IsDirty);
