...
namespace ICP.FCM.DomesticTrade.UI.Common
{
    ...
    public partial class FeePart : DevExpress.XtraEditors.XtraUserControl, IChildPart
    {
        ...
        IDomesticTradeService DomesticTradeService { get { return Workitem.Services.Get<IDomesticTradeService>(); } }
        #endregion 
        ...
        private void barDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    DomesticTradeService.RemoveDTOrderFeeList(needRemoveIDs.ToArray(), LocalData.UserInfo.LoginID, needRemoveUpdateDate.ToArray(), LocalData.IsEnglish);
                }
