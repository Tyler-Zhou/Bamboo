...
namespace ICP.FCM.DomesticTrade.UI
{
    public class DomesticTradePrintHelper
    {
        ...
        {
            return System.Windows.Forms.Application.StartupPath + "\\Reports\\Domestic\\";
        }
        ...
        {
            DTOrderReportData data = DTReportSrvice.GetDTOrderReportData(orderID);
        ...
        {
            BookingConfirmationReportData data = DTReportSrvice.GetBookingConfirmationReportData(bookingID);
            if (data == null) return null;
        ...
        {
            ContainerPackingReportData data = DTReportSrvice.GetContainerPackingReportData(containerID);
            if (data == null) return null;
        ...
        {
            ShippingOrderReportData data = DTReportSrvice.GetShippingOrderReportData(blID);
            if (data == null) return null;
        ...
        {
            PickupCNReportData data = DTReportSrvice.GetPickupCNReportData(truckID);
            if (data == null) return null;
