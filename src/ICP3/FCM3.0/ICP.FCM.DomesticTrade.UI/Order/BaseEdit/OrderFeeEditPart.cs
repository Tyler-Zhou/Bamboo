...
namespace ICP.FCM.DomesticTrade.UI.Order
{
    ...
    public partial class OrderFeeEditPart : DevExpress.XtraEditors.XtraUserControl, IChildPart
    {
        ...
        IDomesticTradeService oceanExportService { get { return Workitem.Services.Get<IDomesticTradeService>(); } }
        ...
        public object DataSource
        {
            get
            {
                ...
                if (feePartAR.DataSource != null)
                    list.AddRange(feePartAR.DataSource as List<DTBookingFeeList>);
        ...
        public void SetSource(object value) 
        {
            ...
            List<DTBookingFeeList> list = value as List<DTBookingFeeList>;
        ...
        {
            List<DTBookingFeeList> list = this.DataSource as List<DTBookingFeeList>;
            if (list != null)
            {
        ...
        public List<FeeSaveRequest> SaveFee(Guid OrderID)
        {
            ...
            List<DTBookingFeeList> fees = this.DataSource as List<DTBookingFeeList>;
            if (fees.Count != 0)
            {
                List<DTBookingFeeList> changedFees = fees.FindAll(o => o.IsDirty);
        ...
        public void RefreshUI(List<FeeSaveRequest> list)
        {
            ...
            {
                List<DTBookingFeeList> changedFees = feeInfo.UnBoxInvolvedObject<DTBookingFeeList>();
                ManyResult result = feeInfo.ManyResult;

                //ManyResult result = this.DomesticTradeService.SaveOceanOrderFeeList(feeInfo);
