...
{
    [ToolboxItem(false)]
    public partial class DTOrderToolBar : ICP.Framework.ClientComponents.UIFramework.BaseToolBar
    {
        #region Service
        ...
        {
            this.Workitem.Commands[DTOrderCommandConstants.Command_RefreshData].Execute();
        }
