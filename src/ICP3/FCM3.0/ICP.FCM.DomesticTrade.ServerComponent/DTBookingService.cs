...
namespace ICP.FCM.DomesticTrade.ServiceComponent
{
    ...
    {
        public Dictionary<Guid, SaveResponse> SaveDTBookingWithTrans(BookingSaveRequest saveRequest,
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, option))
            {
                ...
                if (saveRequest != null)
                {
                    result.Add(saveRequest.RequestId,
                        new SaveResponse { RequestId = saveRequest.RequestId, SingleResult = this.SaveDTBookingInfo(saveRequest, IsEnglish) });
                ...
                if (_container != null)
                {
                    foreach (ContainerSaveRequest con in _container)
                    {
                        if (saveRequest != null && saveRequest.id == Guid.Empty)
                        {
                            con.oceanBookingID = newBookingOrderId;
                            con.containerIDs = new Guid?[con.containerIDs.Length];
                        }
                        result.Add(con.RequestId,
                            new SaveResponse { RequestId = con.RequestId, ManyResult = this.SaveDTContainerInfo(con, IsEnglish) });
                    }
                }
                scope.Complete();
                return result;
        ...
        public List<DTBookingList> GetDTBookingList(
            Guid[] companyIDs,
            string operationNo,
            string ctnNo,
            ...
            bool IsEnglish)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetInternalBookingList");
                ...
                List<DTBookingList> results = BulidDTBookingListByDataSet(ds);
        ...
        /// <returns></returns>
        public List<DTBookingList> GetDTBookingListByIds(Guid[] bookingIDs, bool IsEnglish)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetInternalBookingListByIDs");
        ...
        /// <param name="maxRecords">最大记录数</param>
        /// <returns>返回订舱列表</returns>
        public List<DTBookingList> GetDTBookingListForFaster(
            Guid[] companyIDs,
            ...
            bool IsEnglish)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetInternalBookingListForFaster");
        ...
        private static List<DTBookingList> BulidDTBookingListByDataSet(DataSet ds)
        {
            List<DTBookingList> results = (from b in ds.Tables[0].AsEnumerable()
                                           select new DTBookingList
                                           {
                                               ID = b.Field<Guid>("ID"),
                                               ...
                                               DTOperationType = (FCMOperationType)b.Field<byte>("InOperationType"),
                                               ...
                                               //                 State = (BLState)m.Field<byte>("State"),
                                               ...
                                               //                 State = (BLState)h.Field<byte>("State"),
                                               ...
                                               //                     {
                                               //                         DTBookingID = c.Field<Guid>("OceanBookingID"),
                                               //                         ID = c.Field<Guid>("ID"),
        ...
        public DTBookingInfo GetDTBookingInfo(Guid id, bool IsEnglish)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetInternalBookingInfo");
                ...
                DTBookingInfo result = (from b in ds.Tables[0].AsEnumerable()
                                        select new DTBookingInfo
                                        {
                                            BookingDate = b.Field<DateTime>("BookingDate"),
                                            SODate = b.Field<DateTime?>("SODate"),
                                            ...
                                            //MBLReleaseType = b.IsNull("MBLReleaseType") ? (ReleaseType?)null : (ReleaseType)b.Field<byte>("MBLReleaseType"),
                                            ...
                                            OceanShippingOrderID = b.Field<Guid?>("InternalTradeShippingOrderID"),
                                            OceanShippingOrderNo = b.Field<string>("ShippingOrderNo"),
                                            ...
                                            //                     select new BookingContainerInfo
                                            //                     {
                                            //                         DTBookingID = h.Field<Guid>("OceanBookingID"),
                                            //                         ID = h.Field<Guid>("ID"),
                                            //                         NO = h.Field<string>("No"),
        ...
        public SingleResult SaveDTBookingInfo(BookingSaveRequest saveRequest, bool IsEnglish)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspSaveInternalBookingInfo");
                ...
                db.AddInParameter(dbCommand, "@InOperationType", DbType.Int16, saveRequest.dtOperationType);
                ...
                db.AddInParameter(dbCommand, "@InternalTradeShippingOrderID", DbType.Guid, saveRequest.oceanShippingOrderID);
                ...
                db.AddInParameter(dbCommand, "@InternalTradeShippingOrderUpdateDate", DbType.DateTime, saveRequest.oceanShippingOrderUpdateDate);
                ...
                SingleResult result = db.SingleResult(dbCommand, new string[] { "ID", "UpdateDate", "InternalTradeShippingOrderUpdateDate", "InternalTradeShippingOrderID", "No", "State" });
                return result;
            }
            catch (SqlException sqlException)
            {
        ...
        public List<ShippingOrderList> GetShippingOrderList(
            FCMOperationType dtOperationType,
            Guid? POLID,
            Guid? PODID,
            ...
            bool IsEnglish)
        {
            try
            {
                ...
                db.AddInParameter(dbCommand, "@BookingType", DbType.Int16, dtOperationType);
