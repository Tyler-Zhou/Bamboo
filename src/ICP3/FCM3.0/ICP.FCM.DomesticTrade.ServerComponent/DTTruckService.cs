    ...
    partial class DomesticTradeService
    {
        ...
        public SingleResult GetTruckRecentData(Guid orderID,bool IsEnglish)
        {
            try
            {
                ...
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetInternalTruckRecentData");
        ...
        public List<DTTruckInfo> GetDTTruckServiceList(Guid InternalBookingID, bool IsEnglish)
        {
            ArgumentHelper.AssertGuidNotEmpty(InternalBookingID, "InternalBookingID");

            try
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspGetInternalTruckServiceList");

                db.AddInParameter(dbCommand, "@InternalTradeBookingID", DbType.Guid, InternalBookingID);
                db.AddInParameter(dbCommand, "@IsEnglish", DbType.Boolean,IsEnglish);
                ...
                List<DTTruckInfo> results = (from b in ds.Tables[0].AsEnumerable()
                                                select new DTTruckInfo
                                                {
                                                    
                                                    ID = b.Field<Guid>("ID"),
                                                    OceanBookingID = b.Field<Guid>("InternalTradeBookingID"),
                ...
                //foreach (OceanTruckInfo t in results)
                //{
                ...
                //                        ContainerID = b.IsNull("OceanContainerID") ? Guid.Empty : b.Field<Guid>("OceanContainerID"),
        ...
        public HierarchyManyResult SaveDTTruckServiceInfo(TruckSaveRequest saveRequest,bool IsEnglish)
        {
            ArgumentHelper.AssertGuidNotEmpty(saveRequest.oceanBookingID, "InternalTradeBookingID");
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspSaveInternalTruckServiceInfo");
                ...
                db.AddInParameter(dbCommand, "@InternalTradeBookingID", DbType.Guid, saveRequest.oceanBookingID);
        ...
        public void RemoveDTTruckServiceInfo(
            Guid id,
            Guid removeByID,
            DateTime? updateDate,
            bool IsEnglish)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand dbCommand = db.GetStoredProcCommandWithTimeout("fcm.uspRemoveInternalTruckServiceInfo");
        ...
        public void RemoveDTTruckContainerInfo(
           Guid[] ids,
           Guid removeByID,
