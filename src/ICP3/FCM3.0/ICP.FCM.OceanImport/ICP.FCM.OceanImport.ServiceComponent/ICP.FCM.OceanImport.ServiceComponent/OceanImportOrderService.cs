...
namespace ICP.FCM.OceanImport.ServiceComponent
{
    partial class OceanImportService
    {
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, option))
            {
                ...
                if (orderSaveRequest != null)
                {
                    result.Add(orderSaveRequest.RequestId,
                        new SaveResponse { RequestId = orderSaveRequest.RequestId, SingleResult = this.SaveOIOrderInfo(orderSaveRequest) });
                }
        ...
        /// <returns></returns>
        public List<OceanOrderList> GetOIOrderListByIds(Guid[] orderIds)
        {
            try
            {
        ...
        /// <returns></returns>
        public OceanOrderInfo GetOIOrderInfo(Guid id)
        {
            try
            {
                Database db = DatabaseFactory.CreateDatabase();
        ...
        /// <returns></returns>
        public SingleResult CancelOIOrder(
               Guid orderID,
               bool isCancel,
               Guid changeByID,
               DateTime? updateDate)
