...
//-----------------------------------------------------------------------
// <copyright file="OIContainerList.cs" company="LongWin">
...
namespace ICP.FCM.OceanImport.ServiceInterface
{
    ...
    /// 箱列表对象
    /// </summary>
    public partial class OIBusinessContainerList : IDXDataErrorInfo
    {
        public OIBusinessContainerList()
        {
        ...
        void IDXDataErrorInfo.GetPropertyError(string propertyName, ErrorInfo info)
        {
            switch (propertyName)
            {
                ...
                case "TypeID":
                    if (this.ContainerTypeID == System.Guid.Empty)
                    {
