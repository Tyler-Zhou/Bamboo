...
namespace ICP.FCM.OceanImport.UI
{
    ...
    {      
        ...
        private void InitControls()
        {
            ...
            //单号类型
            Utility.SetEnterToExecuteOnec(cmbNoSearchType, delegate
            {
                ...
                {
                    if (item.Value == OIBusinessNoSearchType.All)
                    {
                        continue;
                    }
            ...
            //客户类型
            Utility.SetEnterToExecuteOnec(cmbCustomerSearchType, delegate
           {
               ...
               {
                   if (item.Value== OIBusinessCustomerSearchType.All)
                   {
                       continue;
                   }
            ...
            //地点类型
            Utility.SetEnterToExecuteOnec(cmbPortSearchType, delegate
            {
                ...
                {
                    if(item.Value== OIBusinessPortSearchType.All)
                    {
                        continue;
                    }
            ...
            //时间类型
            Utility.SetEnterToExecuteOnec(cmbDateSearchType, delegate
            {
                ...
                {
                    if(item.Value== OIBusinessDateSearchType.All)
                    {
                        continue;
                    }
            ...
            //时间内容
            Utility.SetEnterToExecuteOnec(cmbDateType, delegate
           {
               ...
               {
                   if(item.Value== OIBusinessDateValueSearchType.UnKnow)
                   {
                       continue;
                   }
        ...
        public override object GetData()
        {
            ...
            List<OceanOrderList> list = oiService.GetOIOrderListByFastSearch(
                                 companyIDs.ToArray(),
