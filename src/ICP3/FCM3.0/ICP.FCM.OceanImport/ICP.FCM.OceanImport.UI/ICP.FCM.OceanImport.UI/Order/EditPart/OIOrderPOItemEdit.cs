...
namespace ICP.FCM.OceanImport.UI
{
    ...
    public partial class POItemEditPart : DevExpress.XtraEditors.XtraUserControl, IChildPart
    {
        ...
        IOceanImportService OIService { get { return Workitem.Services.Get<IOceanImportService>(); } }
        ...
        private void DeleteData()
        {
            ...
            {
                //if (IsOrderPO)
                OIService.RemoveOIOrderPOInfo(CurrentRow.ID, LocalData.UserInfo.LoginID, CurrentRow.UpdateDate);
                //else
        ...
        public void InitData(Guid orderId)
        {
            if (orderId != Guid.Empty)
            {
                ...
                {
                    _oceanBookingPOInfo = this.OIService.GetOIOrderPOList(this.OrderId);
                }
        ...
        /// <returns></returns>
        public List<POSaveRequest> GetPoList(Guid orderId)
        {
