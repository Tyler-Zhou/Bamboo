    ...
    public partial class OIBusinessRelease : BaseEditPart
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SingleResult result = oiService.SetOIReleaseData(list.ID, (FCMReleaseType)this.cmbReleaseType.EditValue, this.dtpReleaseDate.DateTime, list.UpdateDate, LocalData.UserInfo.LoginID);
