...
namespace ICP.FCM.OceanImport.UI.Business
{
    public partial class UCHBL2CtnList : ICP.Framework.ClientComponents.UIFramework.BasePart
    {
        ...
        private void InitControls()
        {
            ...
            List<OIBusinessContainerList> list=oIService.GetOIHBL2Container(HBLID);
        ...
        private void barSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            ManyResult many=oIService.SaveOIHBL2Container(HBLID, idList.ToArray(), LocalData.UserInfo.LoginID);
