...
namespace ICP.FCM.OtherBusiness.ServiceComponent
{
    partial class OtherBusinessService
    {
        ...
        public List<OBFeeList> GetOBOrderFeeList(Guid orderID, bool IsEnglish)
        {
            ...
            try
            {
                ...
                List<OBFeeList> results = (from b in ds.Tables[0].AsEnumerable()
        ...
        public ManyResult SaveOBOrderFeeList(FeeSaveRequest feeInfo, bool IsEnglish)
        {
        ...
        /// <param name="updateDates">更新时间-做数据版本用</param>
        public void RemoveOBOrderFeeList(
            Guid[] ids,
            Guid removeByID,
