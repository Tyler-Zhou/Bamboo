...
namespace ICP.FCM.Common.UI.AgentRequest
{
    public partial class AssignAgentRequestPart : BaseEditPart
    {
        ...
        private void InitControls()
        {
            ...
            dfService.Register(stxtAgent, CommonFinderConstants.CustomerAgentFinder, ICP.Common.UI.SearchFieldConstants.CodeName, ICP.Common.UI.SearchFieldConstants.ResultValue,
        ...
        private bool ValidateData()
        {
            ...
            if(currentData.Validate(delegate(ValidateEventArgs e)
                {
                    if (Utility.GuidIsNullOrEmpty(currentData.AgentID))
                    { 
