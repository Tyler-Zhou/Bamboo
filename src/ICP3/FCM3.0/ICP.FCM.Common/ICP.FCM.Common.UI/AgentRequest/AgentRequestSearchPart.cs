...
namespace ICP.FCM.Common.UI.AgentRequest
{
    ...
    public partial class AgentRequestSearchPart : ICP.Framework.ClientComponents.UIFramework.BaseSearchPart
    {
        ...
        private void InitControls()
        {
            ...
            List<ICP.Framework.CommonLibrary.Helper.EnumHelper.ListItem<ICP.Framework.CommonLibrary.Client.OperationType>> bussinessTypes
                = ICP.Framework.CommonLibrary.Helper.EnumHelper.GetEnumValues<ICP.Framework.CommonLibrary.Client.OperationType>(LocalData.IsEnglish);
        ...
        public override object GetData()
        {
            ...
            ICP.Framework.CommonLibrary.Client.OperationType? bussinessType = null;
            if (cmbOperationType.EditValue != null && cmbOperationType.EditValue != System.DBNull.Value)
            {
                bussinessType = (ICP.Framework.CommonLibrary.Client.OperationType)cmbOperationType.EditValue;
            }
