...
// </copyright>
//-----------------------------------------------------------------------
namespace ICP.FCM.OtherBusiness.ServiceInterface.DataObjects.ReportObjects
{
    using System;
    ...
    /// </summary>
    [Serializable]
    public class OBOrderReportData
    {
        /// <summary>
        /// 构造函数        /// </summary>
        public OBOrderReportData()
        {
            this.Fees = new List<OBOrderFeeReportData>();
        }
        ...
        /// 订单费用
        /// </summary>
        public List<OBOrderFeeReportData> Fees { get; set; }
    }
    ...
    /// </summary>
    [Serializable]
    public class OBOrderFeeReportData
    {
        /// <summary>
        /// ID
        /// </summary>
