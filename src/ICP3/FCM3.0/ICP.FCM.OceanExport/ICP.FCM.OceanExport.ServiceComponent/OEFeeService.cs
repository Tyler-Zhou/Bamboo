...
namespace ICP.FCM.OceanExport.ServiceComponent
{
    partial class OceanExportService
    {
        ...
        public List<OceanBookingFeeList> GetOceanOrderFeeList(Guid orderID)
        {
            ...
            try
            {
                ...
                List<OceanBookingFeeList> results = (from b in ds.Tables[0].AsEnumerable()
        ...
        /// <param name="updateDates">更新时间-做数据版本用</param>
        public void RemoveOceanOrderFeeList(
            Guid[] ids,
            Guid removeByID,
