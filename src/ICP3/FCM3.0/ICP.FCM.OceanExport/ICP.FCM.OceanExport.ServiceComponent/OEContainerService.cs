...
namespace ICP.FCM.OceanExport.ServiceComponent
{
    partial class OceanExportService
    {
            ...
            List<CargoSaveRequest> cargos, List<POSaveRequest> pos, PoItemContainersRelationSaveRequest relations)
        {
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, option))
            {
                ...
                if (containers != null)
                {
                    ...
                    {
                        ManyResult temp = this.SaveOceanContainerInfo(saveRequest);
                ...
                if (cargos != null)
                {
                    foreach (CargoSaveRequest saveRequest in cargos)
                    {
                        ...
                        result.Add(saveRequest.RequestId,
                            new SaveResponse { RequestId = saveRequest.RequestId, ManyResult = this.SaveOceanMBLContainerCargoInfo(saveRequest) });
                    }
                }
                ...
                if (pos != null)
                {
                    ...
                    {
                        HierarchyManyResult temp = this.SaveOceanOrderPOInfo(saveRequest);
                ...
                if (relations != null)
                {
                    this.SaveOceanContainerPOInfo(relations.poContainerIds, relations.poIds, relations.saveByID);
                    this.SaveOceanContainerPOItemInfo(relations.itemContainerIds, relations.itemIds, relations.saveByID);
                }
        ...
        public void RemoveOceanContaierInfo(
           Guid[] ids,
           Guid removeByID,
