...
namespace ICP.FCM.OceanExport.ServiceComponent
{
    ...
    public class OEReportDataService : IOEReportDataService
    {
        ...
        /// <returns></returns>
        public OEOrderReportData GetOEOrderReportData(Guid orderID)
        {
            try
            {
                ...
                FCMBLType blType)
        {
            try
            {
                ...
                if (shipperDscription != null) reportData.Shipper = shipperDscription.ToString(this.IsEnglish).ToUpper();
                ...
                if (consigneeDscription != null) reportData.Consignee = consigneeDscription.ToString(this.IsEnglish).ToUpper();
                ...
                if (notifyPartyDscription != null) reportData.NotifyParty = notifyPartyDscription.ToString(this.IsEnglish).ToUpper();
                ...
                if (agentDscription != null) reportData.Agent = agentDscription.ToString(this.IsEnglish).ToUpper();
                                               ...
                                               select new OEBusinessReportData
                                                        {
                                                            ...
                                                            State = EnumHelper.GetDescription<OEOrderState>((OEOrderState)b.Field<byte>("State"), this.IsEnglish),
