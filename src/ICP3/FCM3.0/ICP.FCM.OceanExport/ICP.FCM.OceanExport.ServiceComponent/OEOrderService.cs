...
namespace ICP.FCM.OceanExport.ServiceComponent
{
    ...
    {
        public Dictionary<Guid, SaveResponse> SaveOceanOrderWithTrans(OrderSaveRequest saveRequest, List<FeeSaveRequest> fees, List<POSaveRequest> pos)
        {
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, option))
            {
                ...
                if (saveRequest != null)
                {
                    result.Add(saveRequest.RequestId,
                        new SaveResponse { RequestId = saveRequest.RequestId, SingleResult = this.SaveOceanOrderInfo(saveRequest) });
            ...
            int maxRecords)
        {
            ...
            try
            {
                ...
                List<OceanOrderList> results = BulidOrderListByDataSet(ds);
        ...
        public OceanOrderInfo GetOceanOrderInfo(Guid id)
        {
            ...
            try
            {
                ...
                OceanOrderInfo result = (from b in ds.Tables[0].AsEnumerable()
        ...
        public SingleResult ChangeOceanOrderState(
            Guid orderID,
            bool isValid,
            Guid changeByID,
            DateTime? updateDate)
        ...
        public List<OceanBookingPOList> GetOceanOrderPOList(Guid orderID)
        {
            ...
            try
            {
                ...
                List<OceanBookingPOList> results = (from b in ds.Tables[0].AsEnumerable()
