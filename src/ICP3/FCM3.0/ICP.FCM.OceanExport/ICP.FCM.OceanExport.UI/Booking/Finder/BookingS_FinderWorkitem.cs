        ...
        public void Show(IWorkspace mainWorkspace, List<OceanBookingList> list, string[] returnFields, Dictionary<string, object> initValues)
        {
            ...
            if (mainSpace == null)
            {
                ...
                _listPart.Selected += delegate(object sender, object data)
                {
                    ...
                    if (DataChoosed != null)
                    {
                        DataChoosed(sender, new DataFindEventArgs(Utility.GetSingleSearchResult<OceanBookingList>(oceanBookingList, returnFields)));
                    }
                };
    ...
    public class OEBookingFinderUIAdapter
    {
        ...
        public void Init(Dictionary<string, object> controls)
        {
            ...
            _mainListPart.Selected += delegate(object sender, object data)
            {
                ...
                if (DataChoosed != null)
                {
                    DataChoosed(sender, new DataFindEventArgs(Utility.GetSingleSearchResult<OceanBookingList>(list, _returnFields)));
                }
            };
