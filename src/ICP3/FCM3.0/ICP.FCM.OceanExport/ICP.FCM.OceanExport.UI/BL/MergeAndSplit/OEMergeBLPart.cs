    ...
    public partial class OEMergeBLPart : BaseEditPart
    {
        ...
        public override bool SaveData()
        {
            ...
            try
            {
                ...
                SingleResult result = oeService.MergeOceanBL(reservationID, blIDs.ToArray(),LocalData.UserInfo.LoginID);
                ...
                if (_BLType == FCMBLType.MBL)
                    ctnList=oeService.GetOceanMBLContainerList(reservationID);
                else
                    ctnList = oeService.GetOceanHBLContainerList(reservationID);

                reservationInfo.ContainerNo = Utility.BulidCtnNOByContainerList(ctnList);
        ...
        void BindingData(object data)
        {
            ...
            List<OceanContainerCargoList> measureInfos = oeService.GetOceanBLMeasureInfoList(ids.ToArray());
