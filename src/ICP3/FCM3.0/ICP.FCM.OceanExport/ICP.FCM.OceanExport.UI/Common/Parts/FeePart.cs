...
namespace ICP.FCM.OceanExport.UI.Common
{
    ...
    public partial class FeePart : DevExpress.XtraEditors.XtraUserControl, IChildPart
    {
        ...
        IOceanExportService oceanExportService { get { return Workitem.Services.Get<IOceanExportService>(); } }
        #endregion 
        ...
        private void barAdd_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (preRow != null)
                newFeeRow = Utility.Clone<OceanBookingFeeList>(preRow);
            else
        ...
        private void barDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    oceanExportService.RemoveOceanOrderFeeList(needRemoveIDs.ToArray(), LocalData.UserInfo.LoginID, needRemoveUpdateDate.ToArray());
                }
        ...
        public bool ValidateData()
        {
            ...
            foreach (var item in bsFee.DataSource as List<OceanBookingFeeList>)
            {
                if (item.Validate
                    (
