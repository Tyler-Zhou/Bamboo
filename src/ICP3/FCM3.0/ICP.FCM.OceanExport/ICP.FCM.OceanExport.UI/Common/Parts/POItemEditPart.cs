...
namespace ICP.FCM.OceanExport.UI
{
    public partial class POItemEditPart : DevExpress.XtraEditors.XtraUserControl, IChildPart
    {
        ...
        IOceanExportService OeService { get { return Workitem.Services.Get<IOceanExportService>(); } }
        ...
        private void DeleteData()
        {
            ...
            {
                //if (IsOrderPO)
                    OeService.RemoveOceanOrderPOInfo(CurrentRow.ID, LocalData.UserInfo.LoginID, CurrentRow.UpdateDate);
                //else
        ...
        public void InitData(Guid orderId)
        {
            ...
            {                
                ...
                List<OceanBookingPOList> _oceanBookingPOInfo = this.DataSource as List<OceanBookingPOList>;
                if (_oceanBookingPOInfo == null)
                {
                    _oceanBookingPOInfo = this.OeService.GetOceanOrderPOList(this.OrderId);
            ...
            {
                this.SetSource(new List<OceanBookingPOList>());
            }
        }

        void item_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            List<OceanBookingPOList> pos = this.DataSource as List<OceanBookingPOList>;
            if (pos == null)
            {
                return ;
            }
