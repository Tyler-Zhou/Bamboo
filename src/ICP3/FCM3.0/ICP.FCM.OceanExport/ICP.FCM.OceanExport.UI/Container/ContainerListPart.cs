...
namespace ICP.FCM.OceanExport.UI.Container
{
    ...
    public partial class ContainerListPart : BaseEditPart
    {
        ...
        [ServiceDependency]
        public IOceanExportService oceanExportService { get; set; }
        ...
        private void barDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
                ...
                MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                {
                    if (!Utility.GuidIsNullOrEmpty(item.ID))
                    {
                        IDList.Add(item.ID);
                    ...
                    //oceanExportService.RemoveOceanContaierInfo(new Guid[] { item.ID }, LocalData.UserInfo.LoginID, list.ToArray());
                }
        ...
        void BindingData(object data)
        {
            ...
            InitControls();
            _OrgData = Utility.Clone<List<OceanBLContainerList>>(data as List<OceanBLContainerList>);
