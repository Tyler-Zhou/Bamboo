...
namespace ICP.FCM.OceanExport.UI.Container
{
    ...
    public partial class LoadContainerPart : BaseEditPart
    {
        ...
        private void barPrint_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            OceanExportPrintHelper.PrintOELoadContainer(CurrentRow.ID);
        }
        ...
        private void barDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    oeService.RemoveOceanContaierInfo(new Guid[] { CurrentRow.ID }, LocalData.UserInfo.LoginID, new DateTime?[] { CurrentRow.UpdateDate });
                    LocalCommonServices.ErrorTrace.SetSuccessfullyInfo(this.FindForm(), LocalData.IsEnglish ? "Delete Successfully" : "删除成功");
                    gvCtn.DeleteRow(gvCtn.FocusedRowHandle);
                    if (Saved != null)
                    {
        ...
        {
            OceanBookingList bookingList = value as OceanBookingList;
        ...
        private void groupBoxCtn_Enter(object sender, EventArgs e)
        {
