...
namespace ICP.FCM.OtherBusiness.UI.Business
{
    ...
    public partial class TruckPrintPart : BaseEditPart
    {
        #region Service

        [ServiceDependency]
        public IOBReportDataService oeReportSrvice { get; set; }
        ...
        [ServiceDependency]
        public IOtherBusinessService oeService { get; set; }

        //[Dependency(NotPresentBehavior = NotPresentBehavior.CreateNew)]
        //public OBExportUIHelper ExportUIHelper { get; set; }
        ...
        private void Print()
        {
            ...
            //        bs.DataSource = data;
            //        reportFilePath = ExportUIHelper.GetOBReportPath() + "OE_PickupDelivery_EN.frx";
            //    }
            //    else
            //    {
            //        //短格式
            ...
            //        data.CurrentUserName = LocalData.UserInfo.LoginName + (txtEmail.Text.Trim().Length == 0 ? string.Empty : ("//" + txtEmail.Text.Trim()));
            //        bs.DataSource = data;
            //        reportFilePath = ExportUIHelper.GetOBReportPath() + "OE_PickupDelivery_EN_Short.frx";
            //    }
