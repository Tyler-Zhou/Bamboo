...
namespace ICP.FCM.OtherBusiness.UI.Business
{
    ...
    public partial class OBUSPickUpReport : CompositeReportViewPart
    {
        ...
        private void PrintPickUpDelivery()
        {
            ...
            List<ICP.FCM.OtherBusiness.ServiceInterface.DataObjects.ContainerList>  containerList=  obService.GetOtherContainerList(_businessInfo.ID, LocalData.IsEnglish);
        ...
        public override void Init(IDictionary<string, object> values)
        {
            ...
            if (values.ContainsKey(idKey))
            {
                ...
                _businessInfo = obService.GetOtherBusinessInfo(businessID, LocalData.IsEnglish);
            }          
        }
