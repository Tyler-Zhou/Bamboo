...
namespace ICP.FCM.AirExport.ServiceComponent
{
    partial class AirExportService
    {
       ...
       /// <returns></returns>
        ...
        /// <param name="oceanShippingOrderNo">订舱号 AirShippingOrders.oceanShippingOrderNo[20]</param>
        ...
        public SingleResult SaveAirBookingInfo(BookingSaveRequest saveRequest)
        {
            ...
            try
            {
                ...
                //db.AddInParameter(dbCommand, "@PlaceOfDeliveryID", DbType.Guid, saveRequest.placeOfDeliveryID);//收货地
                ...
                //db.AddInParameter(dbCommand, "@AirShippingOrderID", DbType.Guid, saveRequest.oceanShippingOrderID);
                ...
                SingleResult result = db.SingleResult(dbCommand, new string[] { "ID", "No", "AirwayBillID", "UpdateDate", "state", "AirwayBillIDUpdateDate"});
                return result;
            }
            catch (SqlException sqlException)
            {
