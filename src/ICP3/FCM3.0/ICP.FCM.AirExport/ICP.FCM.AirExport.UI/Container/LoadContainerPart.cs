...
namespace ICP.FCM.AirExport.UI.Container
{
    ...
    public partial class LoadContainerPart : BaseEditPart
    {
        ...
        void gvCtn_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                BindingList<AirContainerList> containers = this.bsContainer.DataSource as BindingList<AirContainerList>;
        ...
        private bool Save()
        {
            ...
            if (originalPos != null)
            {
                ...
                this.poItemPart1.RefreshUI(originalPos);
            }
        ...
        void AfterSave()
        {
            if (Saved != null)
            {
                BindingList<AirContainerList> list = this.bsContainer.DataSource as BindingList<AirContainerList>;
                if (list != null)
                {
        ...
        private void barDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    oeService.RemoveAirContaierInfo(new Guid[] { CurrentRow.ID }, LocalData.UserInfo.LoginID, new DateTime?[] { CurrentRow.UpdateDate });
                    LocalCommonServices.ErrorTrace.SetSuccessfullyInfo(this.FindForm(), LocalData.IsEnglish ? "Delete Successfully" : "删除成功");
                    gvCtn.DeleteRow(gvCtn.FocusedRowHandle);
                    if (Saved != null)
                    {
        ...
        void BindingData(object value)
        {
            ...
            CompositeContainerObjects cco = oeService.GetCompositeContainerObjects(bookingList.ID);
            ...
            this._ccl.ICPCommUIHelper = this.ICPCommUIHelper;
        ...
        {
            BindingList<AirContainerList> containerList = this.bsContainer.DataSource as BindingList<AirContainerList>;
        ...
        void SetChildParts()
        {
            ...
            if (this.xtraTabControl1.SelectedTabPage == this.tabPagePO)
            {
                ...
                {
                    this.poItemPart1.SetAllPO(this.bookingInfo.ID, this.Workitem, this.CurrentRow.ID);

                    this.poItemPart1.SetRelationShips(this.CurrentRow.ID);
                }
