...
namespace ICP.FCM.AirExport.UI.HBL
{
    ...
    public partial class HAWBEditPart : BaseEditPart
    {
        ...
        void SetComboboxSource()
        {
            ...
            {
                AirBookingList booking = aeService.GetAirBookingListByIds(new Guid[] { _CurrentBLInfo.AirBookingID })[0];
        ...
        //{
        //    if ((Guid)this.txtDepartureCode.Tag == Guid.Empty) { Utility.ShowMessage(LocalData.IsEnglish ? "Please select POL at first." : "请先选择起运港！"); return; }
        //    if ((Guid)this.txtDetinationCode.Tag == Guid.Empty) { Utility.ShowMessage(LocalData.IsEnglish ? "Please select POD at first." : "请先选择目的港！"); return; }
        ...
        //        else
        //        {
        //            Utility.ShowMessage(LocalData.IsEnglish ? "No corresponding flight." : "没有找到对应的航班号！");
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        ...
        private bool Save()
        {
            ...
            try
            {
                ...
                SingleResult resultData = aeService.SaveAirHBLInfo(hbl);
        ...
        void AfterSave(bool IsSaveAs)
        {
            ...
            stxtRefNo.Properties.ReadOnly = true;
            stxtRefNo.Properties.Buttons[0].Enabled = false;
            this.Title = LocalData.IsEnglish ? "Edit HAWB " + _CurrentBLInfo.No : "编辑HAWB " + _CurrentBLInfo.No;
            RefreshBarEnabled();
        ...
        bool SaveAs()
        {
            ...
            try
            {
                ...
                SingleResult result = aeService.SaveAirHBLInfo(mbl);
        ...
        private void barSubCheck_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            using (new CursorHelper(Cursors.WaitCursor))
            {
                ...
                try
                {
                    SingleResult result = aeService.ChangeAirHBLState(_CurrentBLInfo.ID, AEBLState.Checked, LocalData.UserInfo.LoginID, _CurrentBLInfo.UpdateDate);
        ...
        private void RefreshBLData()
        {
            ...
            //{
            this.Focus();
            _CurrentBLInfo = aeService.GetAirHBLInfo(_CurrentBLInfo.ID);
            _CurrentBLInfo.CancelEdit();
            _CurrentBLInfo.BeginEdit();
