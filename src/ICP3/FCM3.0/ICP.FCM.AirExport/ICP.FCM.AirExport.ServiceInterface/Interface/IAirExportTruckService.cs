namespace ICP.FCM.AirExport.ServiceInterface
{
    ...
    /// 空运出口拖车服务
    /// </summary>
    [ServiceInfomation("空运出口拖车服务")]
    [ServiceContract]
    public interface IAirExportTruckService
    {
        /// <summary>
        /// 根据业务ID获取拖车行最近业务信息
        /// </summary>
        ...
        [FunctionInfomation]
        [OperationContract]
        List<AirTruckInfo> GetAirTruckServiceList(Guid oceanBookingID);
        ...
        [FunctionInfomation]
        [OperationContract]
        HierarchyManyResult SaveAirTruckServiceInfo(TruckSaveRequest saveRequest);
        ...
        [FunctionInfomation]
        [OperationContract]
        void RemoveAirTruckContainerInfo(
            Guid[] ids,
            Guid removeByID,
