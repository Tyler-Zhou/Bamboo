...
namespace ICP.FCM.AirExport.ServiceInterface.DataObjects
{
    ...
    /// </summary>
    [Serializable]
    public class AirOrderList : BaseDataObject
    {
        /// <summary>
        /// 是否新建数据（尚未保存到数据库的）
        /// </summary>
        ...
        public Guid? FilerId
        {
            ...
            set
            {
                ...
                {
                    _filerId = value;
                    this.NotifyPropertyChanged(p => p.FilerId);
                }
            }
        }
        ...
        public string FilerName
        {
            ...
            set
            {
                ...
                {
                    _filerName = value;
                    this.NotifyPropertyChanged(p => p.FilerName);
                }
            }
        }
        ...
        /// 起运港名称
        /// </summary>
        [StringLength(MaximumLength = 100, CMessage = "起运港", EMessage = "POLName")]
        ...
        /// 目的港名称
        /// </summary>
        [StringLength(MaximumLength = 100, CMessage = "目的港", EMessage = "PODName")]
    ...
    public partial class AirOrderInfo : AirOrderList
    {
        ...
        /// 收货地ID
        /// </summary>
        [GuidRequired(CMessage = "交货地", EMessage = "PlaceOfReceipt")]
    ...
    /// </summary>
    [Serializable]
    public partial class AirBookingPOList : BaseDataObject
    {
        ...
        /// 卖主
        /// </summary>
        [StringLength(MaximumLength = 200, CMessage = "", EMessage = "VendorName")]
        ...
        /// 最终目的地
        /// </summary>
        [StringLength(MaximumLength = 100, CMessage = "最终目的地", EMessage = "FinalDsetination")]
        ...
        List<AirPOItemList> _items;
        /// <summary>
        /// Item列表
        /// </summary>
        public List<AirPOItemList> Items
        {
            get
            {
                return _items;
    ...
    /// </summary>
    [Serializable]
    public partial class AirBookingPOInfo : AirBookingPOList
    {
    }
    ...
    /// </summary>
    [Serializable]
    public partial class AirPOItemList : BaseDataObject
    {
        ...
        /// 大小
        /// </summary>
        [StringLength(MaximumLength = 50, CMessage = "颜色", EMessage = "Size")]
        public string Size
        {
            get
            {
        ...
        /// 空关编码
        /// </summary>
        [StringLength(MaximumLength = 20, CMessage = "空关编码", EMessage = "HTSCode")]
    ...
    /// </summary>
    [Serializable]
    public partial class AirPOItemInfo : AirPOItemList
    {
    }
    ...
    /// </summary>
    [Serializable]
    public partial class AirBookingFeeList : BaseDataObject
    {
