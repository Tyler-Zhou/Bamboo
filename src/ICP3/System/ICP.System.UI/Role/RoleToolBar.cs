...
{
    public partial class RoleToolBar : ICP.Framework.ClientComponents.UIFramework.BaseToolBar
    {
        #region Service
        ...
        {
            Workitem.Commands[RoleCommonConstants.Common_DisuseData].Execute();
        }

        private void barAdd_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            Workitem.Commands[RoleCommonConstants.Common_AddData].Execute();
        }

        private void barSearch_ItemClick(object sender, ItemClickEventArgs e)
        {
            Workitem.Commands[RoleCommonConstants.Command_ShowSearch].Execute();
        }
