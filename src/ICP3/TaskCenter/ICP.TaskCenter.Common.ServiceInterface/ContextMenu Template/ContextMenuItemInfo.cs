...
{   
   ...
   public class ContextMenuItemInfo:ITemplateItemData
    {   
        ...
        /// 类型
        /// </summary>
        public ContexuMenuItemType Type
        {
            get;
            set;
        }
        ...
        public ITemplateItemData Init(XElement element)
        {
            ...
            if (this.Type == ContexuMenuItemType.MenuItem)
            {
                ReadText(element);
            }
            return this;
        ...
        private void ReadOrdinaryPropertyValues(XElement element)
        {
            ...
            this.Type = (ContexuMenuItemType)Enum.Parse(typeof(ContexuMenuItemType), element.Attribute("Type").Value);
        }
