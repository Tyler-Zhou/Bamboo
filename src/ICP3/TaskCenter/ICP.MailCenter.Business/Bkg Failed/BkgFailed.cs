...
using ICP.Common.Business.ServiceInterface;
...
namespace ICP.Common.Business.ServiceInterface
{
    ...
    public partial class BkgFailed : BaseEditPart
    {
        ...
        /// </summary>
        //[State]
        public BaseBusinessPart_New CurrentBaseBusinessPart
        {
            get { return workItem.State["CurrentBaseBusinessPart"] as BaseBusinessPart_New; }
