...
{
    [ToolboxItem(false)]
    public partial class SalesActivitySearchPart : ReportBaseSearchPart
    {
        #region Service
        ...
        public SalesActivitySearchPart()
        {
            InitializeComponent();
        ...
        public string XMLCondition
        {
            get
            {
                ...
                writer.WriteValue(this.cmbCustomerType.EditValue.ToString());
                writer.WriteEndElement();
        ...
        public override object GetData()
        {
            ...
            paramList.Add(new ReportParameter("StartDate", operationDatePart1.FromDate.ToString("yyyy-MM-dd")));
            paramList.Add(new ReportParameter("EndDate", operationDatePart1.ToDate.ToString("yyyy-MM-dd")));
            ...
            ReportData rd = new ReportData { 
                ...
                ,ReportName = "Report_CRM_GetSalesActityTotal" 
            };
            return rd;
        }
