...
{
    [ToolboxItem(false)]
    public partial class DirectionForTEUSearchPart : ReportBaseSearchPart
    {
        #region Service
        ...
        public DirectionForTEUSearchPart()
        {
            InitializeComponent();
        ...
        public override object GetData()
        {
            ...
            ReportData rd = new ReportData { Parameters = paramList, ReportName = "RPT_ALLGetDirectionForTEU" };
            return rd;
        }
