...
{
    [ToolboxItem(false)]
    public partial class PorfitForTSearchPart : ReportBaseSearchPart
    {
        #region Service
        ...
        private void InitControls()
        {
            ...
            cmbGroupBy.Properties.Items.Add(new DevExpress.XtraEditors.Controls.ImageComboBoxItem(LocalData.IsEnglish ? "Company" : "业务发生地", "业务发生地"));
            cmbGroupBy.Properties.Items.Add(new DevExpress.XtraEditors.Controls.ImageComboBoxItem(LocalData.IsEnglish ? "Job Type" : "业务类型", "业务类型"));
            cmbGroupBy.Properties.Items.Add(new DevExpress.XtraEditors.Controls.ImageComboBoxItem(LocalData.IsEnglish ? "Sales Type" : "揽货方式", "揽货方式"));
            cmbGroupBy.Properties.Items.Add(new DevExpress.XtraEditors.Controls.ImageComboBoxItem(LocalData.IsEnglish ? "Ship Owner" : "船公司", "船公司"));
            cmbGroupBy.Properties.Items.Add(new DevExpress.XtraEditors.Controls.ImageComboBoxItem(LocalData.IsEnglish ? "Line" : "航线", "航线"));
        ...
        public string XMLCondition
        {
            get
            {
                ...
                writer.WriteValue(this.cmbGroupBy.EditValue);
                writer.WriteEndElement();
        ...
        public override object GetData()
        {
            ...
            ReportData rd = new ReportData { Parameters = paramList, ReportName = "RPT_ALLPorfitForT" };
            return rd;
        }
