...
{
    [ToolboxItem(false)]
    public partial class ProfitForDirectionSearchPart : ReportBaseSearchPart
    {
        #region Service
        ...
        public ProfitForDirectionSearchPart()
        {
            InitializeComponent();
        ...
        public override object GetData()
        {
            ...
            paramList.Add(new ReportParameter("IsDayOrMonth", cmbStatisticsType.SelectedIndex.ToString()));
            ...
            ReportData rd = new ReportData { Parameters = paramList, ReportName = "RPT_ALLGetDirectionForProfit" };
            return rd;
        }
