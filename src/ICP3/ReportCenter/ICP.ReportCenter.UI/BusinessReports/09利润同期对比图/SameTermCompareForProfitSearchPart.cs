...
{
    [ToolboxItem(false)]
    public partial class SameTermCompareForProfitSearchPart : ReportBaseSearchPart
    {
        #region Service
        ...
        public SameTermCompareForProfitSearchPart()
        {
            InitializeComponent();
        ...
        public override object GetData()
        {
            ...
            ReportData rd = new ReportData { Parameters = paramList, ReportName = "RPT_ALLGetSameTermCompareForProfit" };
            return rd;
        }
