...
{
    [ToolboxItem(false)]
    public partial class PortfolioAndProfitForGeneral_TotalSearchPart : ReportBaseSearchPart
    {
        #region Service
        ...
        private string CommandNameShowCUFFee = "RP_CPAPT_CUF";
        bool IsShowCUFFee = false;

        public PortfolioAndProfitForGeneral_TotalSearchPart()
        {
            InitializeComponent();
        ...
        {
            base.OnLoad(e);
            if (LocalCommonServices.PermissionService.HaveActionPermission(CommandNameShowCUFFee))
            {
                IsShowCUFFee = true;
            }
            InitControls();
        ...
        public override object GetData()
        {
            ...
            paramList.Add(new ReportParameter("IsCommerceReport", "1"));
            paramList.Add(new ReportParameter("IsShowCUF", IsShowCUFFee ? "1":"0"));
            
            ReportData rd = new ReportData { Parameters = paramList, ReportName = "RPT_ALLPortfolioAndProfitForGeneral_Total" };
            return rd;
        }
