...
{
    [ToolboxItem(false)]
    public partial class CostForDirectionSearchPart : ReportBaseSearchPart
    {
        #region Service
        ...
        public CostForDirectionSearchPart()
        {
            InitializeComponent();
        ...
        {
            Utility.BulidComboboxItem<ReportStatisticsType>(cmbStatisticsType, 0);
        ...
        public string XMLCondition
        {
            get
            {
                ...
                writer.WriteValue(cmbStatisticsType.SelectedIndex.ToString());
                writer.WriteEndElement();
        ...
        public override object GetData()
        {
            ...
            paramList.Add(new ReportParameter("IsYear", cmbStatisticsType.SelectedIndex.ToString()));
            ...
            ReportData rd = new ReportData { Parameters = paramList, ReportName = "RPT_ALLCostForDirection" };
            return rd;
        }
