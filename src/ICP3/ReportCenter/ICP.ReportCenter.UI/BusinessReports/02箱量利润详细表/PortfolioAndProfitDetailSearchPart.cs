...
{
    [ToolboxItem(false)]
    public partial class PortfolioAndProfitDetailSearchPart : ReportBaseSearchPart
    {
        #region Service
        ...
        public PortfolioAndProfitDetailSearchPart()
        {
            InitializeComponent();
        ...
        public override object GetData()
        {
            ...
            ReportData rd = new ReportData { Parameters = paramList, ServiceReportPath = ReportPathConstants.BusinessReports, ReportName = "RPT_ALLPortfolioAndProfitForGeneral_Detail" };
            return rd;
        }
