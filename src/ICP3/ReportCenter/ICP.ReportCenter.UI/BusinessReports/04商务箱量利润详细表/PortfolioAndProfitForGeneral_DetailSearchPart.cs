...
{
    [ToolboxItem(false)]
    public partial class PortfolioAndProfitForGeneral_DetailSearchPart : ReportBaseSearchPart
    {
        #region Service
        ...
        public PortfolioAndProfitForGeneral_DetailSearchPart()
        {
            InitializeComponent();
        ...
        private void InitControls()
        {
            ...
            Utility.BulidComboboxItem<ReportYesNoType>(cmbIsAttachType, 0);
        ...
        public string XMLCondition
        {
            get
            {
                ...
                writer.WriteValue(this.cmbIsAttachType.SelectedIndex);
                writer.WriteEndElement();
                ...
                writer.WriteValue(this.txtComm.Text.Trim());
                writer.WriteEndElement();
        ...
        public override object GetData()
        {
            ...
            ReportData rd = new ReportData { Parameters = paramList, ReportName = "RPT_CommercePortfolioAndProfitForGeneral_Detail" };
            return rd;
