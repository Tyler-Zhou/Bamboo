...
namespace ICP.EDI.ServiceInterface
{
    ...
    public class CLP_BillInfo
    {
        ...
        /// 货物信息（必填）							
        /// </summary>
        public List<CLP_CargoInfo> cargoList { get; set; }
    }
    ...
    public class CLP_Result
    {
        ...
        /// 明细
        /// </summary>
        public CLP_ResultDetail data { get; set; }
