...

{
	...
	public class ParseStringToXML : Altova.TraceProvider 
	{
	...
	class seq1_Main : IEnumerable
	{
		...
		class Enumerator : Altova.Mapforce.IMFEnumerator
		{
			...
			seq1_Main closure;
			string var11_const_;
			string var10_const_ParseStringToXml;
			...
			public bool MoveNext()
			{
				while (state != 0)
				{
					...
					case 1:
						state = 5;				
						var11_const_ = ("");
						var10_const_ParseStringToXml = ("ParseStringToXml");
					...
					case 6:
						...
						var13_map_filter_elements = (Altova.Functions.Core.FilterElements(Altova.Functions.Core.CreateQName("ParseStringToXmlResponse", var14_const_http___www_CityOcean), (Altova.Mapforce.IMFNode)Altova.Functions.Core.First(Altova.Functions.Core.FilterElements(var9_create_qname, (Altova.Mapforce.IMFNode)Altova.Functions.Core.First(Altova.Functions.Core.FilterElements(var8_create_qname, Altova.Xml.InternalXML.CallWebservice(Altova.Functions.Core.CreateElement(var8_create_qname, Altova.Functions.Core.Box(Altova.Functions.Core.CreateElement(var9_create_qname, Altova.Functions.Core.Box(Altova.Functions.Core.CreateElement(Altova.Functions.Core.CreateQName(var10_const_ParseStringToXml, var14_const_http___www_CityOcean), (new seq2_create_element(closure.var2_string, closure.var3_length, closure.var4_maxRow, closure.var5_style))))))), "Service1", var10_const_ParseStringToXml, Altova.Functions.Lang.StringAsQName("{http://www.CityOcean.com/}ParseStringToXml"), "http://www.CityOcean.com/ParseStringToXml", "http://app.cityocean.com:83/EDIService.asmx", "document", var11_const_, var11_const_, 0, var11_const_, var11_const_, 1))))))).GetEnumerator();
						goto case 19;			
					case 9:
						state = 9;				
		...
		class Enumerator : Altova.Mapforce.IMFEnumerator
		{
			...
			public bool MoveNext()
			{
				while (state != 0)
				{
					...
					case 1:
						state = 0;				
						if (!(Altova.Functions.Core.Exists(Altova.Functions.Core.FilterElements(Altova.Functions.Core.CreateQName("ParseStringToXmlResult", "http://www.CityOcean.com/"), closure.var1_cur_filter_elements)))) { state = 0; return false; }
						var2_const_ = ("");
			...
			public bool MoveNext()
			{
				while (state != 0)
				{
					...
					case 1:
						...
						var1_map_filter_elements = (Altova.Functions.Core.FilterElements(Altova.Functions.Core.CreateQName("string", var2_const_http___www_CityOcean), (Altova.Mapforce.IMFNode)Altova.Functions.Core.First(Altova.Functions.Core.FilterElements(Altova.Functions.Core.CreateQName("ParseStringToXmlResult", var2_const_http___www_CityOcean), closure.var3_cur_filter_elements)))).GetEnumerator();
						goto case 5;			
					case 5:
						state = 5;				
