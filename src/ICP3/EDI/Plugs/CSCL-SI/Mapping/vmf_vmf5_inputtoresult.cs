...
namespace vmf
{
    ...
    public class vmf5_inputtoresult : Altova.TraceProvider
    {
        ...
        static vmf5_inputtoresult()
        {
            hash[Altova.CoreTypes.ParseBoolean("true")] = "27";
            hash[Altova.CoreTypes.ParseBoolean("false")] = "26";
        }
