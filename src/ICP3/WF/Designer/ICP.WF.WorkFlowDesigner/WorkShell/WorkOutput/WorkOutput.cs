//-----------------------------------------------------------------------
// <copyright file="ShellOutputPart.cs" company="ICP">
...
namespace ICP.WF.WorkFlowDesigner
{
	...
	/// 输出窗口.
	/// </summary>
    public class WorkOutput : XtraUserControl, IWorkOutput
    {
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WorkOutput));
            ...
            // barRemoveSelectItem
            // 
            this.barRemoveSelectItem.Image = global::ICP.WF.WorkFlowDesigner.Properties.Resources.删除;
            ...
            // barClearAll
            // 
            this.barClearAll.Image = global::ICP.WF.WorkFlowDesigner.Properties.Resources.删除;
