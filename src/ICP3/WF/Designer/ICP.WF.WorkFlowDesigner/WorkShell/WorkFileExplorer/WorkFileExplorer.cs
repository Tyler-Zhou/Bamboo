...
//-----------------------------------------------------------------------
// <copyright file="ShellFileExplorer.cs" company="ICP">
...
namespace ICP.WF.WorkFlowDesigner
{
    ...
    /// 表单文件浏览器.
    /// </summary>
    public class WorkFileExplorer : BaseListPart, IWorkFileExplorer
    {
        ...
        private void InitTreeView()
        {
            ...
            DocumentNode folderNode = new DocumentNode(DefaultConfigMananger.Default.FolwDesignFolder.Path,ToolboxGroupType.Workflow);
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WorkFileExplorer));
        ...
        void treeView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                OpentDesignFormEvent(treeView1, e);
            }
        }
        ...
        public void AddFolderFileNode(string nodeText, string filePath)
        {
        ...
        /// </summary>
        /// <param name="nodeText">节点文本</param>
        /// <param name="fileName">表单文件路径</param>
