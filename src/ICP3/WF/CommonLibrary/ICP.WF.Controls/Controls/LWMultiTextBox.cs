...
namespace ICP.WF.Controls
{
    ...
    /// 多行文本控件
    /// </summary>
    [ToolboxBitmap(typeof(BaseEdit), "Bitmaps256.MemoEdit.bmp")]
    [DefaultProperty("DataProperty"),
    SRDescription("MultiTextBoxDesc"),
    SRTitle("MultiTextBoxTitel")]
    [Serializable()]
    public class LWMultiTextBox : MemoEdit
        , IBindingService
        , IValidateService
        , IColumn
    {
        ...
        [SRDisplayName("DispScrollBars"),
        ICPBrowsable(true),
        SRDescription("DescScrollBars"),
        SRCategory("Layout")]
        public  ScrollBars ScrollBars 
        {
            get
            {
                return base.Properties.ScrollBars;
            }
            set
            {
                base.Properties.ScrollBars = value;
            }
        }
        /// <summary>
        /// 布局
