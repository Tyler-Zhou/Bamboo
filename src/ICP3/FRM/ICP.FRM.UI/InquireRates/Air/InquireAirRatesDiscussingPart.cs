...
{
    public partial class InquireAirRatesDiscussingPart : XtraUserControl
    {
        #region 服务
        ...
        public InquireAirRatesDiscussingPart()
        {
            InitializeComponent();
            Enabled = false;
            Disposed += delegate {
        ...
        public ClientInquierAirRate CurrentInquierRate = null;
        ...
        [EventSubscription(InquireRatesCommandConstants.Command_RefreshAirDiscussingPart)]
        public void RefreshAirDiscussingPart(object sender, DataEventArgs<object> e)
        {
            try
            {
                _curruntDiscussingList = InquireRatesService.GetInquireRateDiscussingList(CurrentInquierRate.ID, LocalData.UserInfo.LoginID);
        ...
        public void SetData(WorkItem workitem, ClientInquierAirRate inquierOceanRate)
        {
            Workitem = workitem;
