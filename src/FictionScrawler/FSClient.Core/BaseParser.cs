...
namespace FSClient.Core
{
    ...
    public class BaseParser
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual string PostHtmlContent()
        {
            return string.Empty;
        }
        #endregion
    ...
    /// Web Client 解析器
    /// </summary>
    public class WebClientParser : BaseParser
    {
        #region 成员(Member)
        /// <summary>
        /// Web Client
        ...
        public WebClientParser(string url)
        {
            Url = url;
        }
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        public override string PostHtmlContent()
        {
            string htmlContent = string.Empty;
            try
            {
    ...
    /// <summary>
    /// HTTP Web Request 解析器
    /// </summary>
    public class HttpWebRequestParser:BaseParser, IDisposable
    {
        #region 成员(Member)
        /// <summary>
        /// 请求对象
        ...
        /// </summary>
        /// <param name="url"></param>
        public HttpWebRequestParser(string url)
        {
            Url = url;
        }
        #endregion
